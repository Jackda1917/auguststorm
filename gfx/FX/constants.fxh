...
static const float GB_CAM_MIN = 50.0f; // was 100
static const float GB_CAM_MAX = 225.0f; // was 350
static const float GB_CAM_MAX_FILLING_CLAMP = 1.0f; // was 0.8 -- 0 to 1 value for clamping the fill when camera is at max distance
static const float GB_THRESHOLD = 0.05f; // interpolation time
static const float GB_THRESHOLD2 = 0.125f; // was 0.25 -- interpolation time
...
static const float GB_OPACITY_NEAR = 0.75; // was 1 -- Transparency when camera is near
static const float GB_OPACITY_FAR = 1.0f;  // was 0.9 -- Transparency when camera is far
