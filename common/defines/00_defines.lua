...
NDiplomacy = {
	...
	TRUCE_BREAK_COST_PP = 500,						--WAS 200 Base cost in PP of breaking a truce by joining a war or accepting a call to war ( you cannot declare war yourself until the truce if up ), this is then multiplied by the time left on the truce ( so once half the truce is up it only cost 50% of this )
	BASE_PEACE_ANNEX_FACTOR = 100,					-- Base factor for annexation in %.
	BASE_PEACE_PUPPET_FACTOR = 80,					--WAS 100 Base factor for puppet in %.
	BASE_PEACE_LIBERATE_FACTOR = 60,				--WAS 100 Base factor for liberate in %.
	BASE_PEACE_TAKE_UNCONTROLLED_STATE_FACTOR = 20.0, --WAS 10.0 Base factor for taking state you do not control
	...
	BASE_PEACE_FORCE_GOVERNMENT_COST = 70, 		--WAS 100 Base cost for forcing a country to change government.
	BASE_IMPROVE_RELATION_COST = 20,                --WAS 10 Political power cost to initiate relation improvement
	BASE_IMPROVE_RELATION_SAME_IDEOLOGY_GROUP_MAINTAIN_COST = 0.1, --WAS 0.2 Political power cost each update when boosting relations with nation of same ideology
	BASE_IMPROVE_RELATION_DIFFERENT_IDEOLOGY_GROUP_MAINTAIN_COST = 1,    --WAS 0.4 Political power cost each update when boosting relations with nation of different ideology
	...
	BASE_GENERATE_WARGOAL_DAILY_PP = 0.25,			--WAS 0.2 Daily pp cost for generation of wargoals
	WARGOAL_VERSUS_MAJOR_AT_WAR_REDUCTION = -0.75, 	-- reduction of pp cost for wargoal vs major at war.
	WARGOAL_WORLD_TENSION_REDUCTION = -0.75,		--WAS -0.5 Reduction of pp cost for wargoal at 100% world tension, scales linearly
	...
	BASE_BOOST_PARTY_POPULARITY_DAILY_DRIFT = 0.05, --WAS 0.1 Daily amount of popularity that will be added by the activity.
	...
	NAP_EXPIRY_MONTHS = 60,                         --WAS 48 NAPs expire after this many months
	...
	NAP_BREAK_FORCE_BALANCE_1 = 3.0,              	--WAS 2-1 brigades along the border required to break NAP
	NAP_BREAK_FORCE_BALANCE_2 = 1.5,              	--WAS 1-1 brigades along the border required to break NAP
	NAP_BREAK_FORCE_BALANCE_3 = 0.5,              	-- 1-2 brigades along the border required to break NAP
	VERY_GOOD_OPINION = 99,							--WAS 50 Threshold for a country that has a very good opinion of you.
	...
	TRADE_OPINION_FACTOR_FACTOR = 0.5,				--WAS 1.0 How much the factor should effect the possible trade amount. Setting TRADE_NEUTRAL_OPINION_FACTOR to 1.0 and TRADE_OPINION_FACTOR_FACTOR to 0 means opinion does nothing in regards to trade.
	DIPLOMACY_HOURS_BETWEEN_REQUESTS = 24,			-- How long a country must wait before sending a new diplomatic request.
	TROOP_FEAR = 3, 								--WAS 1 Impact on troops on borders when deciding how willing a nation is to trade
	FLEET_FEAR = 2,									--WAS 1 Impact on troops on borders when deciding how willing a nation is to trade
	IC_TO_EQUIPMENT_COUP_RATIO = 0.33,				--WAS 0.1 Ratio for calculating cost of staging coup
	VOLUNTEERS_PER_TARGET_PROVINCE = 0.02,			--WAS 0.05 Each province owned by the target country contributes this amount of volunteers to the limit.
	VOLUNTEERS_PER_COUNTRY_ARMY = 0.01,				--WAS 0.05 Each army unit owned by the source country contributes this amount of volunteers to the limit.
	VOLUNTEERS_RETURN_EQUIPMENT = 0.70,				--WAS 0.95 Returning volunteers keep this much equipment
	VOLUNTEERS_TRANSFER_SPEED = 20,					--WAS 14 days to transfer a unit to another nation
	VOLUNTEERS_DIVISIONS_REQUIRED = 30,				-- This many divisons are required for the country to be able to send volunteers.
	TENSION_STATE_VALUE = 3,						--WAS 2 Tension value gained by annexing one state
	TENSION_CIVIL_WAR_IMPACT = 0.1,					--WAS 0.2 civil war multiplier on tension.
	TENSION_NO_CB_WAR = 25,							--WAS 15 Amount of tension generated by a no-CB war
	TENSION_CB_WAR = 4,								--WAS 5 Amount of tension generated by a war with a CB
	TENSION_ANNEX_NO_CLAIM = 6,						--WAS 2 Amount of tension generated by annexing a state you don't have claims on
	TENSION_ANNEX_CLAIM = 2,						--WAS 1 Amount of tension generated by annexing a state you DO have claims on
	TENSION_ANNEX_CORE = 0.25,						--WAS 0.5 Amount of tension generated by annexing a state that is your core
	TENSION_PUPPET = 1,								--WAS 2 Amount of tension generated by puppeting (per state)
	TENSION_GENERATE_WARGOAL = 1,					-- Amount of tension generated by generating a wargoal against a country
	TENSION_VOLUNTEER_FORCE_DIVISION = 1,			--WAS 0.5 Amount of tension generated for each sent division
	TENSION_DECAY = 0.15,							--WAS 0.1 Each months tension decays this much
	TENSION_SIZE_FACTOR = 1.0,						-- action tension values are multiplied by this value
	...
	TENSION_GUARANTEE = -5,							
	TENSION_FACTION_JOIN = 5,						--WAS 4
	TENSION_JOIN_ATTACKER = 6,						--WAS 2 scale of the amount of tension added when country joins attacker side
	TENSION_PEACE_FACTOR = 0.5,						--WAS 0.25 scale of the amount of tension (from war declaration) reduced when peace is completed.
	TENSION_LIBERATE = -1,							-- Amount of tension generated by liberating a country. 
	TENSION_CAPITULATE = 0.5,						--WAS 0.75 Scale of the amount of tension created by a countries capitulation.
	GUARANTEE_COST = 250,							--WAS 25 Scale with the number of already guaranteed countries.
	...
	BASE_CONDITIONAL_PEACE_MONTHS = 5,				--WAS 6 War length must be before a surrender i possible.
	JOINING_NAP_WAR_PENALTY = 0.3,					--WAS 0.2 National Unity penalty for breaking non-breakable NAP
	BREAKING_GUARANTEE_PENALTY = 0.4,				--WAS 0.2 National Unity penalty for breaking guarantee
	...
	OPINION_PER_VOLUNTEER = 20,						--WAS 3 Opinion bonus per one sent volunteer division
	MAX_OPINION_FROM_VOLUNTEERS = 10,				--WAS 30 Opinion bonus per one sent volunteer division
	...
	NOT_READY_FOR_WAR_BASE = -300, 					--WAS -50 AI should be unwilling to enter accept a call to war if not ready for war against the relevant enemies.
	...
	TAKE_STATES_PUPPET_COST_MULT = 0.2,				--WAS 0.5 Cost multiplier for feeding states to a puppet that you have created, assuming the puppet currently owns the states
	TAKE_STATES_LIBERATE_COST_MULT = 0.2,			--WAS 0.5 Cost multiplier for feeding states to a country that has been liberated, assuming the country has cores on the states
	TAKE_STATES_CHANGE_GOV_COST_MULT = 0.1,			--WAS 0.5 Cost multiplier for feeding states to a country you are changing government on, assuming they currently own the states	
	...
	AUTONOMY_FREEDOM_FROM_CAPITULATE = 0.75,        --WAS 0.5 if overlord capitulate you get this
	...
	IDEOLOGY_JOIN_FACTION_MIN_LEVEL = 0.25,			--WAS 0.3 ideology limit required to join faction
	...
	LICENSE_ACCEPTANCE_OPINION_FACTOR = 0.4,		--WAS 0.2 Opinion modifier for acceptance of license production requests.
	LICENSE_ACCEPTANCE_PUPPET_BASE = 40,			--WAS 20 Acceptance modifier for puppets requesting production licenses.
	...
	LICENSE_ACCEPTANCE_SAME_FACTION = 60,			--WAS 20 Acceptance modifier for being in the same faction
},
...
NCountry = {
	...
	VP_TO_SUPPLY_BASE = 2,							--WAS 1 Bonus to supply from a VP, no matter the level
	...
	SUPPLY_FROM_DAMAGED_INFRA = 0.2,                --WAS 0.3 damaged infrastructure counts as this in supply calcs
	SUPPLY_BASE_MULT = 1,							-- multiplier on supply base values
	SUPPLY_BONUS_FROM_INPUT = 0.15,					--WAS 0.25 % of supply bonus from input area.
	SUPPLY_PATH_MAX_DISTANCE = 10,					--WAS 15 When supply route reach more than X nodes, the manpower+equipment delivery speed reach 100% penalty.
	POPULATION_YEARLY_GROWTH_BASE = 0.02,			--WAS 0.015 basic population growth per year, used for monthly manpower gain
	RESISTANCE_STRENGTH_FROM_VP = 0.001,			-- How much strength ticking speed gives each VP score.
	RESISTANCE_STRENGTH_FROM_UNIT = 0.002,			--WAS 0.001 How much strength ticking speed is reduced from each unit in state (multiplies subunit value resistance_suppress)
	...
	RESISTANCE_DECAY_WHEN_NO_GROWTH = 0.003,		--WAS 0.005 Resistance will fall by this much each day if there is nothing increasing it ( no VPs and no spread from neighbors )
	...
	REINFORCEMENT_DELIVERY_SPEED_MIN = 0.5,			--WAS 0.6 The distance from the supply region to capital should affect the speed only a little bit. Main factor for penalty is overcrowded areas, and not the route length.
	REINFORCEMENT_EQUIPMENT_DELIVERY_SPEED = 0.2,	--WAS 0.3 Modifier for army equipment reinforcement speed
	REINFORCEMENT_MANPOWER_DELIVERY_SPEED = 8.0,	--WAS 10 Modifier for army manpower reinforcement delivery speed (travel time)
	...
	EQUIPMENT_UPGRADE_CHUNK_MAX_SIZE = 1,			--WAS 10 Maximum chunk size of equipment upgrade distribution per update.
	...
	WEEKLY_STABILITY_GAIN = 0.001,					-- WAS 0.0
	WEEKLY_WAR_SUPPORT_GAIN = -0.001,				-- WAS 0.0
	...
	SUPPLY_CONVOY_FACTOR = 0.33,					--WAS 0.25 How many convoys each supply needs
	CONVOY_RANGE_FACTOR = 1,                        -- how much range affects convoy need
	LOCAL_MANPOWER_ACCESSIBLE_FACTOR = 0.33,         --WAS 0.5 accessible recruitable factor base
	...
	DEFAULT_WAR_SUPPORT = 0.2,						--WAS 0.5 Default war support if not scripted otherwise.
	BASE_STABILITY_WAR_FACTOR = 0.1,				--WAS -0.3 Default stability war factor
	BASE_STABILITY_PARTY_POPULARITY_FACTOR = 0.1,	--WAS 0.15 Default stability rulling party popularity factor
	...
	MIN_COUP_SUCCESS_STABILITY = 0.49,				--WAS 0.8 Max stability when coup will happen
	WAR_SUPPORT_OFFNSIVE_WAR = -0.2,				-- Impact of being in offensive war
	WAR_SUPPORT_DEFENSIVE_WAR = 0.2,				--WAS 0.3 Impact of being in defensive war
	...
	MAJOR_MIN_FACTORIES = 50,						--WAS 35 need at least these many factories to become a major
	MAX_INTELLIGENCE_DIFFERENCE = 4.0,				--WAS 3.0 Max difference in intelligence levels between countries
	...
	ARMY_IMPORTANCE_FACTOR = 10.0,					--WAS 5 Army factor for AI and calculations
	TERRAIN_IMPORTANCE_FACTOR = 5.0,				-- Terrain base factor for state strategic value
	VICTORY_POINTS_IMPORTANCE_FACTOR = 7.0,			--WAS 5.0 State victory points importance factor for AI and calculations
	...
	AUTONOMOUS_SPILLOVER = 0.03,					--WAS 0.025 Total score that can be saved to reach next level
	CIVIL_WAR_INVOLVEMENT_MIN_TENSION = 0.9,		--WAS 0.5 base value of world tension to involve other sides to the civil war
	...
	BASE_COMMAND_POWER_GAIN = 0.003,				--WAS 0.006 base value for daily command power gain
...
NProduction = {
	...
	MAX_LINE_RESOURCE_PENALTY = 80,			--WAS 90 Max penalty factor for production lines lacking strategic resources in %.
	RESOURCE_PENALTY_WARNING_CRITICAL_RATIO = 0.7, --WAS 0.8 Switch to red progress bar if penalty is over threshold 
	BASE_FACTORY_SPEED = 4, 					--WAS 5 Base factory speed multiplier (how much hoi3 style IC each factory gives).
	BASE_FACTORY_SPEED_MIL = 5, 				-- Base factory speed multiplier (how much hoi3 style IC each factory gives).
	BASE_FACTORY_SPEED_NAV = 3, 				--WAS 2.5 Base factory speed multiplier (how much hoi3 style IC each factory gives).
	BASE_FACTORY_START_EFFICIENCY_FACTOR = 5,	--WAS 10 Base start efficiency for factories expressed in %.
	BASE_FACTORY_MAX_EFFICIENCY_FACTOR = 40,	--WAS 50 Base max efficiency for factories expressed in %.
	BASE_FACTORY_EFFICIENCY_GAIN = 0.07,		--WAS 1 -- Base efficiency gain for factories per unit produced in %.
	BASE_FACTORY_EFFICIENCY_BALANCE_FACTOR = 0.05, 		--WAS 0.1 Factory efficiency balancing factor
	BASE_FACTORY_EFFICIENCY_VARIANT_CHANGE_FACTOR = 70,	--WAS 90 Base factor for changing production variants in %.
	BASE_FACTORY_EFFICIENCY_PARENT_CHANGE_FACTOR = 20,	--WAS 50 Base factor for changing production parent<->children in %.
	BASE_FACTORY_EFFICIENCY_FAMILY_CHANGE_FACTOR = 40,	--WAS 70 Base factor for changing production with same family in %.
	BASE_FACTORY_EFFICIENCY_ARCHETYPE_CHANGE_FACTOR = 10, 	--WAS 20 Base factor for changing production with same archetype in %.
	...
	ANNEX_STOCKPILES_RATIO = 0.70,		--WAS 1.0 How much stockpiled equipment will be transferred on annexation
	ANNEX_FIELD_EQUIPMENT_RATIO = 0.50,	--WAS 0.25 How much equipment from deployed divisions will be transferred on annexation
	ANNEX_CONVOYS_RATIO = 0.10,			--WAS 0.15 How many convoys will be transferred on annexation
	...
	CAPITULATE_STOCKPILES_RATIO = 0.75, --WAS 0.5 How much equipment from deployed divisions will be transferred on capitulation
	INFRA_MAX_CONSTRUCTION_COST_EFFECT = 0.75, 		--WAS 1 Building in a state with higher infrastructure will reduce the cost of shared buildings.
	...
	LICENSE_EQUIPMENT_SPEED_NO_LICENSE = -0.70,			--WAS -0.5 Penalty for producing non licensed equipment
	CONVERSION_SPEED_BONUS = 2.5,						--was 2 Modifier to the production speed when converting equipment
},

NTechnology = {
	MAX_SUBTECHS = 3,						-- Max number of sub technologies a technology can have.
	BASE_RESEARCH_POINTS_SAVED = 50.0,		--WAS 30 Base amount of research points a country can save per slot.
	BASE_YEAR_AHEAD_PENALTY_FACTOR = 2,		-- Base year ahead penalty
	BASE_TECH_COST = 110,					--WAS 100 base cost for a tech. multiplied with tech cost and ahead of time penalties
...
NBuildings = {
	ANTI_AIR_SUPERIORITY_MULT = 7.0,	--WAS 5.0 How much air superiority reduction to the enemy does our AA guns? Normally each building level = -1 reduction. With this multiplier.
	...
	RADAR_RANGE_MAX = 220,				--WAS 200 Range is interpolated between building levels 1-15.
	...
	SABOTAGE_FACTORY_DAMAGE = 50.0,		--WAS 100 How much damage takes a factory building in sabotage when state is occupied. Damage is mult by (1 + resistance strength), i.e. up to 2 x base value.
	BASE_FACTORY_REPAIR = 0.5,			--WAS 0.3 Default repair rate before factories are taken into account
	BASE_FACTORY_REPAIR_FACTOR = 3.0,	--WAS 2.0 Factory speed modifier when repairing.
	SUPPLY_PORT_LEVEL_THROUGHPUT = 2,   --WAS 3.0 supply throughput per level of naval base
	INFRA_TO_SUPPLY = 2,				-- 
...
NMilitary = {
	COMBAT_VALUE_ORG_IMPORTANCE = 1,		--WAS 1 Multiplier on TotalOrganisation when determining the combat value of a division
	COMBAT_VALUE_STR_IMPORTANCE = 1,		--WAS 1 Multiplier on TotalStrength when determining the combat value of a division
	
	HOURLY_ORG_MOVEMENT_IMPACT = -0.15,		--WAS -0.2 how much org is lost every hour while moving an army.
	ZERO_ORG_MOVEMENT_MODIFIER = -0.9,		--WAS -0.8 speed impact at 0 org.
	INFRA_ORG_IMPACT = 0.5,					-- scale factor of infra on org regain.

	UNIT_DAMAGE_TO_WAR_SUPPORT_REDUCTION_MULT = 0.6, --WAS 0.5 if a unit reduces war support when it is damaged, this base multiplier is multiplied by the total damage they suffered to convert it war support damage
	INFRASTRUCTURE_MOVEMENT_SPEED_IMPACT = -0.05,	-- speed penalty per infrastucture below maximum.

	WAR_SCORE_LOSSES_RATIO = 0.3,				--WAS 0.2 Scale how much losses will affect warscore ( per 1000 losses ).
	WAR_SCORE_LOSSES_MULT_IF_CAPITULATED = 0.5, -- How much your losses count towards warscore if you have capitulated.
	WAR_SCORE_AIR_WORTH = 0.2,              	--WAS 0.1 how much strategic bombing will affect warscore
	...
	FIELD_MARSHAL_DIVISIONS_CAP = 30,			--WAS 24 how many divisions a field marshall is limited to. 0 = inf, < 0 = blocked
	FIELD_MARSHAL_ARMIES_CAP = 4,				--WAS 5 how many armies a field marshall is limited to. 0 = inf, < 0 = blocked
	...
	BASE_DIVISION_BRIGADE_GROUP_COST = 40, 	--WAS 20 Base cost to unlock a regiment slot,
	BASE_DIVISION_BRIGADE_CHANGE_COST = 10,	--WAS 5 Base cost to change a regiment column.
	BASE_DIVISION_SUPPORT_SLOT_COST = 20, 	--WAS 10 Base cost to unlock a support slot
	...
	COMBAT_MINIMUM_TIME = 8,			--WAS 4 Shortest time possible for a combat in hours
	...
	LAND_COMBAT_ORG_DICE_SIZE = 6,                 --WAS 4 nr of damage dice
	LAND_COMBAT_STR_DICE_SIZE = 2,                 -- nr of damage dice
	LAND_COMBAT_STR_DAMAGE_MODIFIER = 0.025,        --WAS 0.05 global damage modifier
	LAND_COMBAT_ORG_DAMAGE_MODIFIER = 0.08,        --WAS 0.05 global damage modifier
	LAND_AIR_COMBAT_STR_DAMAGE_MODIFIER = 0.03,    --WAS 0.04 air global damage modifier
	LAND_AIR_COMBAT_ORG_DAMAGE_MODIFIER = 0.06,    --WAS 0.04 global damage modifier
	LAND_AIR_COMBAT_MAX_PLANES_PER_ENEMY_WIDTH = 4, --WAS 3 how many CAS/TAC can enter a combat depending on enemy width there
	LAND_COMBAT_STR_ARMOR_ON_SOFT_DICE_SIZE = 2,   -- extra damage dice if our armor outclasses enemy
	LAND_COMBAT_ORG_ARMOR_ON_SOFT_DICE_SIZE = 8,   --WAS 5 -- extra damage dice if our armor outclasses enemy
	LAND_COMBAT_STR_ARMOR_DEFLECTION_FACTOR = 1.5, --WAS 0.5 damage reduction if armor outclassing enemy
	LAND_COMBAT_ORG_ARMOR_DEFLECTION_FACTOR = 0.75,--WAS 0.5 damage reduction if armor outclassing enemy
	...
	ATTRITION_EQUIPMENT_LOSS_CHANCE = 0.05,		   --WAS 0.1 Chance for loosing equipment when suffer attrition. Scaled up the stronger attrition is. Then scaled down by equipment reliability.
	ATTRITION_EQUIPMENT_PER_TYPE_LOSS_CHANCE = 0.04, --was 0.1 Chance for loosing equipment when suffer attrition. Scaled up the stronger attrition is. Then scaled down by equipment reliability.
	ATTRITION_WHILE_MOVING_FACTOR = 0.7,		   -- WAS 1
	BASE_CHANCE_TO_AVOID_HIT = 85,                 --WAS 90 Base chance to avoid hit if defences left.
	CHANCE_TO_AVOID_HIT_AT_NO_DEF = 40,	           --WAS 60 chance to avoid hit if no defences left.
	COMBAT_MOVEMENT_SPEED = 0.25,	               --WAS 0.33 speed reduction base modifier in combat
	TACTIC_SWAP_FREQUENCEY = 24,                   -- hours between tactic swaps
	INITIATIVE_PICK_COUNTER_ADVANTAGE_FACTOR  = 0.55, --WAS 0.35 advantage per leader level for picking a counter
	BASE_COMBAT_WIDTH = 100,                       --WAS 80 base combat width
	ADDITIONAL_COMBAT_WIDTH = 50,                  --WAS 40 more opened up by support attack
	...
	RIVER_CROSSING_SPEED_PENALTY = -0.3,           --WAS -0.25 small river crossing
	RIVER_CROSSING_SPEED_PENALTY_LARGE = -0.6,     --WAS -0.5 large river crossing
	RIVER_SMALL_START_INDEX = 0,                   -- color indices for rivers
	RIVER_SMALL_STOP_INDEX = 6,
	RIVER_LARGE_STOP_INDEX = 11,
	BASE_FORT_PENALTY = -0.3, 					   --WAS -0.15 fort penalty
	BASE_STACKING_PENALTY = -0.15,                 --WAS -0.1 multiple direction attack penalty
	MULTIPLE_COMBATS_PENALTY = -0.6,               --WAS -0.5 defender penalty if attacked from multiple directions
	DIG_IN_FACTOR = 0.03,						   --WAS 0.02 bonus factor for each dug-in level
	LEADER_SKILL_FACTOR = 0.08,                     --WAS 0.05 bonus per skill level of leader
	ARMY_LEADER_XP_GAIN_PER_UNIT_IN_COMBAT = 0.08, -- WAS 0.06 XP gain per unit in combat
	...
	BASE_LEADER_TRAIT_GAIN_XP = 0.8,			   --WAS 1 Base xp gain for traits per hour.
	MAX_NUM_TRAITS = -1,						   -- cant have more, -1 to disable
	ENEMY_AIR_SUPERIORITY_IMPACT = -0.6,           --WAS -0.5 effect on defense due to enemy air superiorty
	ENEMY_AIR_SUPERIORITY_DEFENSE = 0.8,	       --WAS 0.7 more AA attack will approach this amount of help (diminishing returns)
	...
	ENCIRCLED_PENALTY = -0.4,                      --WAS -0.3 penalty when completely encircled
	...
	UNIT_EXPERIENCE_PER_COMBAT_HOUR = 0.0002,		-- WAS 0.0001
	UNIT_EXPERIENCE_SCALE = 1.0,
	UNIT_EXPERIENCE_PER_TRAINING_DAY = 0.0005,		-- WAS 0.0015
	TRAINING_MAX_LEVEL = 2,
	DEPLOY_TRAINING_MAX_LEVEL = 1,
	TRAINING_EXPERIENCE_SCALE = 62.0,
	TRAINING_ORG = 0.2,
	ARMY_EXP_BASE_LEVEL = 1,
	UNIT_EXP_LEVELS = { 0.1, 0.3, 0.6, 0.85 },		--WAS { 0.1, 0.3, 0.75, 0.9 }, Experience needed to progress to the next level
	FIELD_EXPERIENCE_SCALE = 0.002,
	FIELD_EXPERIENCE_MAX_PER_DAY = 2,				--WAS 3 Most xp you can gain per day
	EXPEDITIONARY_FIELD_EXPERIENCE_SCALE = 0.33,	--WAS 0.5 reduction factor in Xp from expeditionary forces
	LEND_LEASE_FIELD_EXPERIENCE_SCALE = 0.005,		-- Experience scale for lend leased equipment used in combat.
	LEADER_EXPERIENCE_SCALE = 0.75,                 --WAS 1
	SLOWEST_SPEED = 2,							   -- WAS 4
	...
	EXPERIENCE_COMBAT_FACTOR = 0.15,			   -- WAS 0.25
	...
	UNIT_DIGIN_CAP = 10,                           --WAS 5 how "deep" you can dig you can dig in until hitting max bonus
	...
	BASE_NIGHT_ATTACK_PENALTY = -0.66,			   --WAS 0.5
	...
	EXPERIENCE_LOSS_FACTOR = 0.90,                 --WAS 1.00 percentage of experienced solders who die when manpower is removed
	EQUIPMENT_COMBAT_LOSS_FACTOR = 0.8,	 	  	   --WAS 0.7 % of equipment lost to strength ratio in combat, so some % is returned if below 1
	SUPPLY_USE_FACTOR_MOVING = 1.75,               --WAS 1.5 supply use when moving/fighting vs inactive
	SUPPLY_USE_FACTOR_INACTIVE = 0.60,             --WAS 0.95
	...
	OUT_OF_SUPPLY_ATTRITION = 0.4,                 --WAS 0.3 max attrition when out of supply
	OUT_OF_SUPPLY_SPEED = -0.8,                    -- max speed reduction from supply
	NON_CORE_SUPPLY_SPEED = -0.4,				   --WAS -0.5 we are not running on our own VP supply so need to steal stuff along the way
	NON_CORE_SUPPLY_AIR_SPEED = -0.5,			   --WAS -0.25 we are not running on our own VP supply so need to steal stuff along the way
	OUT_OF_SUPPLY_MORALE = -0.4,                   --WAS -0.3 max org regain reduction from supply
	TRAINING_ATTRITION = 0.006,		  			   --WAS 0.06 amount of extra attrition from being in training
	TRAINING_MIN_STRENGTH = 0.1,				   -- if strength is less than this, the unit will pause training until it's been reinforced
	AIR_SUPPORT_BASE = 0.3,                        --WAS 0.25 CAS bonus factor for air support moddifier for land unit in combat
	...
	BORDER_WAR_ATTRITION_FACTOR = 0.25,			   --WAS 0.1 How much of borderwar balance of power makes it into attrition
	BORDER_WAR_VICTORY = 0.8,					   -- At wich border war balance of power is victory declared
	REINFORCE_CHANCE = 0.03,                 	   --WAS 0.02 base chance to join combat from back line when empty
	SPEED_REINFORCEMENT_BONUS = 0.01,              -- chance to join combat bonus by each 100% larger than infantry base (up to 200%)
	OVERSEAS_LOSE_EQUIPMENT_FACTOR = 0.9,		   --WAS 0.75 percentage of equipment lost disbanded overseas
	ENCIRCLED_DISBAND_MANPOWER_FACTOR = 0.05,      --WAS 0.2 percentage of manpower returned when an encircled unit is disbanded
	ORG_LOSS_FACTOR_ON_CONQUER = 0.25,             --WAS 0.2 percentage of (max) org loss on takign enemy province
	...
	PLANNING_GAIN = 0.02,
	PLANNING_MAX = 0.4,                           	--WAS 0.3 can get more from techs
	CIVILWAR_ORGANIZATION_FACTOR = 0.2,				--WAS 0.3 Multiplier of org for both sides when civilwar.
	...
	PLAN_SPREAD_ATTACK_WEIGHT = 7.0,				--WAS 13.0 The higher the value, the less it should crowd provinces with multiple attacks.
	PLAN_SUPPLY_FACTOR = 0.1,						-- Factor applied to available supply on a front location when determining priority
	PLAN_NEIGHBORING_ENEMY_PROVINCE_FACTOR = 0.2,	--WAS 0.7 When calculating the importance of provinces, it takes number of enemy provinces into account, factored by this
	...
	PLAN_PROVINCE_LOW_VP_IMPORTANCE_AREA = 5.0,     --WAS 2.0 Used when calculating the calue of defense area in the battle plan system
	PLAN_PROVINCE_MEDIUM_VP_IMPORTANCE_AREA = 10.0, --WAS 5.0 Used when calculating the calue of defense area in the battle plan system
	PLAN_PROVINCE_HIGH_VP_IMPORTANCE_AREA = 15.0,   --WAS 10.0 Used when calculating the calue of defense area in the battle plan system
	PLAN_PROVINCE_CAPITAL_IMPORTANCE_AREA = 70.0,	--WAS 50.0 Used when calculating the balue of defense area in the battle plan system
	
	PLAN_PROVINCE_LOW_VP_IMPORTANCE_FRONT = 3.0,    --WAS 2.0 Used when calculating the calue of fronts in the battle plan system
	PLAN_PROVINCE_MEDIUM_VP_IMPORTANCE_FRONT = 6.0, --WAS 3.0 Used when calculating the calue of fronts in the battle plan system
	PLAN_PROVINCE_HIGH_VP_IMPORTANCE_FRONT = 10.0,   --WAS 5.0 Used when calculating the calue of fronts in the battle plan system
	...
	PLAN_PORVINCE_PORT_BASE_IMPORTANCE = 18.0,		--WAS 9.0 Added importance for area defense province with a port
	PLAN_PORVINCE_PORT_LEVEL_FACTOR = 0.5,			--WAS 1.5 Bonus factor for port level
	PLAN_PORVINCE_AIRFIELD_BASE_IMPORTANCE = 5.0,	--WAS 3.0 Added importance for area defense province with air field
	PLAN_PORVINCE_AIRFIELD_POPULATED_FACTOR = 4,	--WAS 1.5 Bonus factor when an airfield has planes on it
	...
	PLAN_AREA_DEFENSE_FORT_IMPORTANCE = 0.5,		  --WAS 0.25 Used when calculating the calue of defense area provinces for the battle plan system, works as multipliers on the rest
	PLAN_AREA_DEFENSE_COASTAL_FORT_IMPORTANCE = 25.0, --was 5 Used when calculating the calue of defense area provinces for the battle plan system
	...
	PLAN_PROVINCE_PRIO_DISTRIBUTION_DPP_HIGH = 5.0, --WAS 4 At what divisions per province should we use PLAN_PROVINCE_PRIO_DISTRIBUTION_MIN
	PLAN_PROVINCE_PRIO_DISTRIBUTION_DPP_LOW = 1.0,	--WAS 2 At what divisions per province should we use PLAN_PROVINCE_PRIO_DISTRIBUTION_MAX
	
	PLAN_EXECUTE_CAREFUL_LIMIT = 15,				--WAS 25 When looking for an attach target, this score limit is required in the battle plan to consider province for attack
	PLAN_EXECUTE_BALANCED_LIMIT = -10,				-- When looking for an attach target, this score limit is required in the battle plan to consider province for attack
	...
	PLAN_EXECUTE_CAREFUL_MAX_FORT = 4,				--WAS 5 If execution mode is set to careful, units will not attack provinces with fort levels greater than or equal to this
	
	PLAN_MAX_PROGRESS_TO_JOIN = 0.5,				-- If Lower progress than this, probably needs support

	PLAN_BLITZ_OPTIMISM = 0.1,						--WAS 0.2 Additional combat balance value in favor of blitzing side when considering targets (not a combat bonus, just offsets planning)
	...
	NUKE_MAX_DAMAGE_PERCENT = 0.99,					--WAS 0.9 Minimum damage from nukes as a percentage of current strength/organisation
	...
	COMBAT_SUPPLY_LACK_IMPACT = -0.45,				--WAS -0.33 combat penalty if out of supply
	COMBAT_STACKING_START = 10,						--WAS 8 at what nr of divisions stacking penalty starts
	COMBAT_STACKING_EXTRA = 5,                      --WAS 4 extra stacking from directions
	COMBAT_STACKING_PENALTY = -0.04,                --WAS -0.02 how much stackign penalty per division
	...
	RETREAT_SPEED_FACTOR = 0.2,                    	--WAS 0.25 speed bonus when retreating
	WITHDRAWING_SPEED_FACTOR = 0.1,					--WAS 0.15 speed bonus when withdrawing	
	...
	BATALION_CHANGED_EXPERIENCE_DROP = 0.25,		--WAS 0.5 Division experience drop if unit has different batalion
	ARMOR_VS_AVERAGE = 0.4,			                --WAS 0.3 how to weight in highest armor & pen vs the division average
	PEN_VS_AVERAGE = 0.5,                           --WAS 0.4

	DECRYPTION_ADVANTAGE_BONUS = 0.10,				--WAS 0.05 How much unit base damage and base defense is increased per decryption level compared to enemies average encryption level (ex: dec. level is 5 and enemy average enc. level is 3 then 5-3 = 2 which gives 10 % increase)
	LAND_EQUIPMENT_BASE_COST = 15,					--WAS 5 (1.1) Cost in XP to upgrade a piece of equipment one level is base + ( total levels * ramp )
	...
	SLOWER_ORG_REGAIN_LEVEL = 0.7,					-- Was 0.75
	SLOWER_ORG_REGAIN_MULT = -0.5,
	DISBAND_MANPOWER_LOSS = 0.7,
	MIN_DIVISION_DEPLOYMENT_TRAINING = 0.1,			--WAS 0.2 Min level of division training
	FRONT_MIN_PATH_TO_REDEPLOY = 6,				    --WAS 8 If a units path is at least this long to reach its front location, it will strategically redeploy.
	ARMY_INITIATIVE_REINFORCE_FACTOR = 0.35,		--WAS 0.25 scales initiative for reinforce chance
	...
	PROMOTE_LEADER_CP_COST = 40.0,					--WAS 30.0 cost of promoting a leader
	...
	UNIT_LEADER_ASSIGN_TRAIT_COST = 30.0,					--WAS 15 cost to assign a new trait to a unit leader
	...
	XP_GAIN_FOR_SHATTERING = 50.0,                          --WAS 30 extra multiplier on XP gain on shattering an encircled enemy
},
...
NAir = {
	...
	COMBAT_DAMAGE_STATS_MULTILIER = 0.5,				--WAS 0.3
	...
	COMBAT_DAMAGE_SCALE = 0.25,							--WAS 0.1 Higher value = more shot down planes
	DETECT_CHANCE_FROM_OCCUPATION = 0.10, 				-- How much the controlled provinces in area affects the air detection base value.
	DETECT_CHANCE_FROM_RADARS = 0.6, 					--WAS 0.5 How much the radars in area affects detection chance.
	DETECT_CHANCE_FROM_AIRCRAFTS_EFFECTIVE_COUNT = 2000, --WAS 3000 Max amount of aircrafts in region to give full detection bonus.
	DETECT_CHANCE_FROM_AIRCRAFTS = 0.15,				--WAS 0.08 How much aircrafts in region improves air detection (up to effective count).
	DETECT_CHANCE_FROM_NIGHT = -0.3,					--WAS -0.2 How much the night can reduce the air detection. (see static modifiers to check how weather affects it too.)
	...
	DETECT_EFFICIENCY_RANDOM_FACTOR = 0.15,				--WAS 0.1 How much randomness is in amount of detected aircrafts.
	...
	HOURS_DELAY_AFTER_EACH_COMBAT = 5,					--WAS 4 How many hours needs the wing to be ready for the next combat. Use for tweaking if combats happens too often. (generally used as double because of roundtrip)
	CARRIER_HOURS_DELAY_AFTER_EACH_COMBAT = 5,          --WAS 4 how often carrier planes do battle inside naval combat
	...
	NAVAL_STRIKE_DAMAGE_TO_STR = 4.0,					--WAS 3 Balancing value to convert damage ( naval_strike_attack * hits ) to Strength reduction.
	...
	FIELD_EXPERIENCE_SCALE = 0.002,						-- WAS 0.003
	FIELD_EXPERIENCE_MAX_PER_DAY = 1,					--WAS 2 Most xp you can gain per day
	CLOSE_AIR_SUPPORT_EXPERIENCE_SCALE = 0.0005,		-- How much the experinence gained by CAS is scaled
	PARADROP_EXPERIENCE_SCALE = 0.05,					--WAS 0.03 How much the experinence gained by paradropping is scaled
	BOMBING_DAMAGE_EXPERIENCE_SCALE = 0.0002,           -- How much the experinence gained by bombing is scaled
	ACCIDENT_CHANCE_BASE = 0.07,						--WAS 0.05 Base chance % (0 - 100) for accident to happen. Reduced with higher reliability stat.
	ACCIDENT_CHANCE_CARRIER_MULT = 2.5,					--WAS 2.0 The total accident chance is scaled up when it happens on the carrier ship.
	...
	ACE_DEATH_CHANCE_BASE = 0.005,						--WAS 0.003 Base chance % for ace pilot die when an airplane is shot down in the Ace wing.
	...
	ACE_EARN_CHANCE_BASE = 0.006,						--WAS 0.003 Base chance % for ace pilot to be created. Happens only when successfully kill airplane/ship or damage the buildings.
	...
	BASE_STRATEGIC_BOMBING_HIT_SHIP_CHANCE = 0.05,		--WAS 0.01 Chance to hit a ship in port when it is bombed.
	BASE_STRATEGIC_BOMBING_HIT_SHIP_DAMAGE_FACTOR = 50,
	BASE_STRATEGIC_BOMBING_HIT_PLANE_CHANCE = 0.75,		--WAS 0.5 Chance to hit a plane in airbase when it is bombed.
	BASE_STRATEGIC_BOMBING_HIT_PLANE_DAMAGE_FACTOR = 0.6, -- WAS 0.2
	...
	ACE_WING_SIZE =	200,								--WAS 100 size of wing ace bonuses are set up for. if lower more bonus, if higher less bonus
	...
	AIR_COMBAT_FINAL_DAMAGE_SCALE = 0.025,               --WAS 0.015 % how many max disrupted only planes are alloed to die in a single combat
	...
	AA_INDUSTRY_AIR_DAMAGE_FACTOR = -0.15,				--WAS -0.12 5x levels = 60% defense from bombing
	...
	ANTI_AIR_PLANE_DAMAGE_FACTOR = 0.85,				--WAS 0.8 Anti Air Gun Damage factor
	ANTI_AIR_PLANE_DAMAGE_CHANCE = 0.15,				--WAS 0.1 Anti Air Gun hit chance
	...
	NAVAL_STRIKE_BASE_STR_TO_PLANES_RATIO = 0.2,		--WAS 0.1 Max airbombers to do port strike comparing to strength
	NAVAL_COMBAT_EXTERNAL_PLANES_JOIN_RATIO = 0.07,		--WAS 0.05 Max planes that can join a combat comparing to the total strength of the ships
	...
	DISRUPTION_FACTOR = 5.0,								--WAS 4.0 multiplier on disruption damage to scale its effects on planes
...
NNavy = {
	DETECTION_CHANCE_MULT_BASE = 0.03,								--WAS 0.04 base multiplier value for detection chance. Later the chance is an average between our detection and enemy visibility, mult by surface/sub detection chance in the following defines.
	DETECTION_CHANCE_MULT_FORMATION_SPREAD_PATROL = 1.8, 			--WAS 1.6 formation spread (max recommended value 1.0). The higher value the higher detection chance, but less ships will be on the place when combat starts.
	...
	DETECTION_CHANCE_MULT_RADAR_BONUS = 0.03,					--WAS 0.02 detection chance bonus from radars. 
	DETECTION_CHANCE_MULT_AIR_SUPERIORITY_BONUS = 0.3,			--WAS 0.25 bonus from air superiority.

	DETECTION_CHANCE_BALANCE = 5.0,								--WAS 2.5 Value to balance gameplay. The higher value = smaller detection chance. Notice: it doesn't affect the displayed detection chance numbers, as well balanced numbers could be a very small fractions like 0.012
	DETECTION_SUBS_CHANCE_BALANCE = 50.0,						--WAS 10.0 Same as above, but for sub detection. It should be very hard to detect just the subs.
	...
	COMBAT_MIN_WIN_CHANCE_TO_KEEP_FIGHTING = 0.51,		 			--WAS 0.2 compare our forces with enemy forces. 1.0 is equal win chances. Less then 1.0 is we have low chances. If we have at least X chances, then ships will attept to attack without waiting for the other ships that are on the way.
	...
	COMBAT_CLOSE_DISTANCE_MAX_HIT_CHANCE_BONUS = 0.02,				--WAS 0 max bonus to hit chance when target is near. So if base is 0.5, dist.bonus is 0.1, and we are facing enemy at distance 0, the total hit chance is 0.6 (60%). When enemy is barely at our max shooting range, the bonus is 0.
	...
	COMBAT_EVASION_TO_HIT_CHANCE_TORPEDO_MULT = 20.0,				--WAS 40 the above evasion hit chance is multiplied by 150% if shooting with torpedos. Torpedoes are slow, so evasion matters more.
	...
	COMBAT_DAMAGE_RANDOMNESS = 0.4,								--WAS 0.3 random factor in damage. So if max damage is fe. 10, and randomness is 30%, then damage will be between 7-10.
	COMBAT_TORPEDO_CRITICAL_CHANCE = 0.1,							--WAS 0.2 chance for critical hit from torpedo.
	COMBAT_TORPEDO_CRITICAL_DAMAGE_MULT = 6.0,						--WAS 2 multiplier to damage when got critical hit from torpedo. (Critical hits are devastating as usualy torpedo_attack are pretty high base values).
	COMBAT_DAMAGE_TO_STR_FACTOR = 1.8,								--WAS 1.6 casting damage value to ship strength multiplier. Use it ot balance the game difficulty.
	...
	COMBAT_SHIP_SPEED_TO_FIELD_FACTOR = 0.02,						--WAS 0.03 Modifier to the ships speed in the combat. For better balance, make it lower to slow down the speed of approaching.
	...
	COMBAT_DETECTED_CONVOYS_FROM_SURFACE_DETECTION_STAT = 0.25,		--WAS 0.1 Each 1.0 of surface_detection that ship has (equipment stat), gives x% of convoys discovered from total travelling along the route.
	...
	COMBAT_CRITICAL_DAMAGE_MULT = 8.0,								--WAS 5.0 Multiplier for the critical damage. Scaled down with the ship reliability.
	...
	REPAIR_AND_RETURN_PRIO_LOW = 0.6,								--WAS 0.2 % of total Strength. When below, navy will go to home base to repair.
	REPAIR_AND_RETURN_PRIO_MEDIUM = 0.75,							--WAS 0.5 % of total Strength. When below, navy will go to home base to repair.
	REPAIR_AND_RETURN_PRIO_HIGH = 0.9,								-- % of total Strength. When below, navy will go to home base to repair.
	REPAIR_AND_RETURN_PRIO_LOW_COMBAT = 0.5,						--WAS 0.1 % of total Strength. When below, navy will go to home base to repair (in combat).
	REPAIR_AND_RETURN_PRIO_MEDIUM_COMBAT = 0.65,					--WAS 0.3 % of total Strength. When below, navy will go to home base to repair (in combat).
	REPAIR_AND_RETURN_PRIO_HIGH_COMBAT = 0.8,						--WAS 0.5 % of total Strength. When below, navy will go to home base to repair (in combat).
	REPAIR_AND_RETURN_AMOUNT_SHIPS_LOW = 0.5,						--WAS 0.2 % of total damaged ships, that will be sent for repair-and-return in one call.
	...
	REPAIR_AND_RETURN_AMOUNT_SHIPS_HIGH = 0.75,						--WAS 0.8 % of total damaged ships, that will be sent for repair-and-return in one call.
	REPAIR_AND_RETURN_MAX_STR_DAMAGE = 0.9,							-- Ships that STR is below this value will be sent for repair and return.
	REPAIR_AND_RETURN_UNIT_DYING_STR = 0.50,						--WAS 0.2 Str below this point is considering a single ship "dying", and a high priority to send to repair.
	EXPERIENCE_LOSS_FACTOR = 0.80,                 					--WAS 1.0 percentage of experienced solders who die when manpower is removed
	...
	UNIT_EXPERIENCE_PER_COMBAT_HOUR = 25,							-- WAS 10
	UNIT_EXPERIENCE_SCALE = 1,
	EXPERIENCE_FACTOR_CONVOY_ATTACK = 0.02,							--WAS 0.05
	EXPERIENCE_FACTOR_NON_CARRIER_GAIN = 0.1,						--WAS 0.05 Xp gain by non-carrier ships in the combat
	EXPERIENCE_FACTOR_CARRIER_GAIN = 0.2,							--WAS 0.1 Xp gain by carrier ships in the combat
	...
	NAVY_VISIBILITY_BONUS_ON_RETURN_FOR_REPAIR = 0.5,				--WAS 0.9 Multiplier for the surface/sub visiblity when the heavily damaged fleet is returning to the home base for reparation. 1.0 = no bonus. 0.0 = invisible.
	NAVAL_SUPREMACY_INTEL_LOW = 0.2,								--WAS 0.3 we need more intel than this to get any supremacy
	NAVAL_SUPREMACY_CAN_INVADE = 0.33,								--WAS 0.5 required naval supremacy to perform invasions on an area
	...
	SUBMARINE_HIDE_TIMEOUT = 2,										--WAS 16 Amount of in-game-hours that takes the submarine (with position unrevealed), to hide.
	SUBMARINE_REVEALED_TIMEOUT = 6,									--WAS 12 Amount of in-game-hours that makes the submarine visible if it is on the defender side.
	SUBMARINE_REVEAL_BASE_CHANCE = 0.02,							--WAS 0.05 Base chance for submarine detection. It's modified by the difference of a spootter's submarines detection vs submarine visibility. Use this variable for game balancing.
	SHORE_BOMBARDMENT_CAP = 0.4,									-- WAS 0.25
	...
	SUPPLY_NEED_FACTOR = 6,										    --WAS 4 multiplies supply usage
	...
	DECRYPTION_SPOTTING_BONUS = 0.3,								-- WAS 0.2
	DISBAND_MANPOWER_LOSS = 0.0,
	XP_GAIN_FACTOR = 1.0,	   			   							-- xp gain factor for navy
},

NTrade = {
	DISTANCE_TRADE_FACTOR = -0.0005,		--WAS -0.02 Trade factor is modified by distance times this
	RELATION_TRADE_FACTOR = 0.50,			--WAS 1 Trade factor is modified by Opinion value times this
	FEAR_TRADE_FACTOR = 2,					--WAS 1
	ALLOW_TRADE_CUT_OFF = 0,				-- If trade factor is less than this, no trade will be allowed
	MONTH_TRADE_FACTOR = 5,				--WAS 2 Each month a trade gets this much boost to it's trade factor
	...
	PUPPET_MASTER_TRADE_FACTOR = 800,		--WAS 400 This is priority for puppet master
	...
	ANTI_MONOPOLY_TRADE_FACTOR = -25,		-- This is added to the factor value when anti-monopoly threshold is exceeded
},
...
NAI = {
	...
	BASE_RELUCTANCE = 30, 						--WAS 20 Base reluctance applied to all diplomatic offers
	DIPLOMATIC_ACTION_RANDOM_FACTOR = 0.25, 	--WAS 0.5 How much of the AI diplomatic action scoring is randomly determined (1.0 = half random, 2.0 = 2/3rd random, etc)
	...
	DIPLOMACY_FACTION_WRONG_IDEOLOGY_PENALTY = 80, --WAS 60 AI penalty for diplomatic faction acitons between nations of different ideologies
	DIPLOMACY_FACTION_SAME_IDEOLOGY_MAJOR = 20, --WAS 10 AI bonus acceptance when being asked about faction is a major of the same ideology
	DIPLOMACY_FACTION_NEUTRALITY_PENALTY = 70,	--WAS 50 Neutral nations have a separate penalty, not wanting to get involved at all, rather than caring much about the difference in ideology
	DIPLOMACY_FACTION_GLOBAL_TENSION_FACTOR = 0.4,--WAS 0.2 How much the AI takes global tension into account when considering faction actions
	DIPLOMACY_LEAVE_FACTION_OPINION_FACTOR = 0.25,--WAS 0.75 How much the opinion of countries being targeted by faction leader matters when deciding to leave a faction (democratic only)
	DIPLOMACY_FACTION_WAR_RELUCTANCE = -100,		--WAS -50 Penalty to desire to enter a faction with a country that we are not fighting wars together with.
	DIPLOMACY_SCARED_MINOR_EXTRA_RELUCTANCE = -85, --WAS -50 extra reluctance to join stuff as scared minor
	DIPLOMACY_FACTION_PLAYER_JOIN = 0,			--WAS 20 Bonus for human players asking to join a faction.
	...
	DIPLOMACY_IMPROVE_RELATION_COST_FACTOR = 8.0,--WAS 5.0 Desire to boost relations subtracts the cost multiplied by this
	DIPLOMACY_IMPROVE_RELATION_PP_FACTOR = 0.1,	-- Desire to boost relations adds total PP multiplied by this
	DIPLOMACY_SEND_ATTACHE_COST_FACTOR = 10.0,	--WAS 5 Desire to send attache substracts the cost multiplied by this
	DIPLOMACY_SEND_ATTACHE_PP_FACTOR = 0.1,		-- Desire to send attache adds total PP multiplied by this
	DIPLOMACY_REJECTED_WAIT_MONTHS_BASE = 3,	--WAS 4 AI will not repeat offers until at least this time has passed, and at most the double
	DIPLOMACY_SEND_MAX_FACTION = 0.50,			--WAS 0.75 Country should not send away more units than this as expeditionaries
	DIPLOMACY_ACCEPT_VOLUNTEERS_BASE = 100,		--WAS 50 Base value of volunteer acceptance (help is welcome)
	...
	DIPLOMACY_FACTION_SURRENDER_LEVEL = 50, 	--WAS 20 How much the recipient nation losing matters for joining a faction
	...
	RESEARCH_LAND_DOCTRINE_NEED_GAIN_FACTOR = 0.2, --WAS 0.15 Multiplies value based on relative military industry size / country size.
	RESEARCH_NAVAL_DOCTRINE_NEED_GAIN_FACTOR = 0.2, --WAS 0.075 (1.1) Multiplies value based on relative naval industry size / country size.
	RESEARCH_AIR_DOCTRINE_NEED_GAIN_FACTOR = 0.5, --WAS 0.08 Multiplies value based on relative number of air base / country size.
	RESEARCH_NEW_WEIGHT_FACTOR = 0.3, 			-- Impact of previously unexplored tech weights. Higher means more random exploration.
	RESEARCH_AHEAD_BONUS_FACTOR = 0.5,          --WAS 2.0 To which extent AI should care about ahead of time bonuses to research
	RESEARCH_BONUS_FACTOR = 9000, 				--WAS 0.9 To which extent AI should care about bonuses to research
	MAX_AHEAD_RESEARCH_PENALTY = 3,             --WAS 2 max ahead of tiem penalty ai will pick ever
	RESEARCH_AHEAD_OF_TIME_FACTOR = 1.0, 		--WAS 4.0 To which extent AI should care about ahead of time penalties to research
	RESEARCH_BASE_DAYS = 10,					--WAS 60 AI adds a base number of days when weighting completion time for techs to ensure it doesn't only research quick techs
	DECLARE_WAR_RELATIVE_FORCE_FACTOR = 0.5,	-- Weight of relative force between nations that consider going to war
	TRADEABLE_FACTORIES_FRACTION = 0.8,			--WAS 0.8 (1.1) Will at most trade away this fraction of factories.
	MIN_DELIVERED_TRADE_FRACTION = 0.8,			--WAS 0.9 (1.1) AI will cancel trade deals that are not able to deliver more than this fraction of the agreed amount
	NAVAL_TRANSPORTS_FACTOR = 2,				-- Factor applied to the relative size of army compared to naval capacity.
	NAVAL_DOCKYARDS_SHIP_FACTOR = 100,			--WAS 1.5 The extent to which number of dockyards play into amount of sips a nation wants
	NAVAL_BASES_SHIP_FACTOR = 70,				--WAS 0.75 The extent to which number of naval bases play into amount of sips a nation wants
	NAVAL_STATES_SHIP_FACTOR = 30,				--WAS 0.75 The extent to which number of states play into amount of sips a nation wants
	...
	PRODUCTION_EQUIPMENT_SURPLUS_FACTOR = 0.1,	--WAS 0.25 Base value for how much of currently used equipment the AI will at least strive to have in stock
	...
	INTERCEPT_NAVAL_BOMBING_FACTOR = 20.0,		--WAS 35 Factors the weight of intercepting naval bombers in sea regions where friendly ships are
	...
	MAX_VOLUNTEER_ARMY_FRACTION = 0.1,			--WAS 0.25 Countries will not send more than their forces time this number to aid another country
	WANTED_UNITS_INDUSTRY_FACTORY = 2, 			--WAS 1.0 How many units a country wants is partially based on how much military industry that is available
	DEPLOY_MIN_TRAINING_PEACE_FACTOR = 0.99,	--WAS 0.95 Required percentage of training (1.0 = 100%) for AI to deploy unit in peacetime
	DEPLOY_MIN_TRAINING_WAR_FACTOR = 0.1,		--WAS 0.30 Required percentage of training (1.0 = 100%) for AI to deploy unit in wartime
	DEPLOY_MIN_EQUIPMENT_PEACE_FACTOR = 0.95,	--WAS 0.95 Required percentage of equipment (1.0 = 100%) for AI to deploy unit in peacetime
	DEPLOY_MIN_EQUIPMENT_WAR_FACTOR = 0.85,		--WAS 0.95 Required percentage of equipment (1.0 = 100%) for AI to deploy unit in wartime
	...
	DIVISION_UPGRADE_MIN_XP = 10,				--WAS 5 Minimum XP before attempting to upgrade a division template.
	DIVISION_CREATE_MIN_XP = 1000,				--WAS 100 Minimum XP before attempting to create a fresh new division template.
	VARIANT_UPGRADE_MIN_XP = 70,				--WAS 50 Minimum XP before attempting to create a new variant.
	UPGRADE_XP_RUSH_UPDATE = 100,				--WAS 150 If XP is above this on the daily tick the AI will attempt to spend it
	...
	VP_GARRISON_VALUE_FACTOR = 0.7,				--WAS 0.75 Extent to which VP garrisons are prioritized, based on VP value and compared to other priority values.
	...
	CALL_ALLY_BASE_DESIRE = 5,					--WAS 20 exactly what it says
	CALL_ALLY_DEMOCRATIC_DESIRE = 20,			--WAS 50 Desire to call ally added for democratic AI
	CALL_ALLY_NEUTRAL_DESIRE = 25,				-- Desire to call ally added for neutral AI
	CALL_ALLY_FASCIST_DESIRE = -95,				-- WAS -10 Desire to call ally added for fascist AI
	CALL_ALLY_COMMUNIST_DESIRE = 75,			-- Desire to call ally added for communist AI
	JOIN_ALLY_BASE_DESIRE = 20,					-- exactly what it says
	JOIN_ALLY_DEMOCRATIC_DESIRE = 20,			--WAS 50 Desire to join ally added for democratic AI
	JOIN_ALLY_NEUTRAL_DESIRE = 5,				--WAS 25 Desire to join ally added for neutral AI
	JOIN_ALLY_FASCIST_DESIRE = -100,			--WAS -10 Desire to join ally added for fascist AI
	JOIN_ALLY_COMMUNIST_DESIRE = 50,			--WAS 75 Desire to join ally added for communist AI
	JOIN_FACTION_BOTH_LOSING = -300,			-- Desire to be in a faction when both we and htey are in losing wars
	LENDLEASE_FRACTION_OF_PRODUCTION = 0.1,		--WAS 0.5 Base fraction AI would send as lendlease
	...
	NEIGHBOUR_WAR_THREAT_FACTOR = 1, 			--WAS 1.10 How much increase in threat does AI feel against neighbours who are at war
	POTENTIAL_ALLY_JOIN_WAR_FACTOR = 50, 		--WAS 100 How much increase in threat does AI feel against neighbours who are allied against one of our enemies
	POTENTIAL_FUTURE_ENEMY_FACTOR = 25, 		--WAS 100 How much increase in threat does AI feel against neighbours who at war with our allies
	...
	PLAN_ATTACK_MIN_ORG_FACTOR_LOW = 0.5,		--WAS 0.85 Minimum org % for a unit to actively attack an enemy unit when executing a plan
	PLAN_ATTACK_MIN_STRENGTH_FACTOR_LOW = 0.3,	--WAS 0.4 Minimum strength for a unit to actively attack an enemy unit when executing a plan
	PLAN_ATTACK_MIN_ORG_FACTOR_MED = 0.4,		--WAS 0.75 (LOW,MED,HIGH) corresponds to the plan execution agressiveness level.
	PLAN_ATTACK_MIN_STRENGTH_FACTOR_MED = 0.2,	
	PLAN_ATTACK_MIN_ORG_FACTOR_HIGH = 0.2,		
	PLAN_ATTACK_MIN_STRENGTH_FACTOR_HIGH = 0.15,	

	PLAN_FRONTUNIT_DISTANCE_FACTOR = 20.0,		--WAS 10 Factor for candidate units distance to front positions.
	PLAN_ATTACK_DEPTH_FACTOR = 0.9,				--WAS 0.5 Factor applied to size or enemy being attacked.
	...
	PLAN_STEP_COST_LIMIT_REDUCTION = 6,			--WAS 3 Cost limit is reduced per iteration, making hard terrain less likely to be crossed the further into enemy territory it is
	...
	PLAN_MIN_SIZE_FOR_FALLBACK = 100,			--WAS 50 A country with less provinces than this will not draw fallback plans, but rather station their troops along the front
	SEND_VOLUNTEER_EVAL_BASE_DISTANCE = 70.0,   --WAS 175 How far away it will evaluate sending volunteers if not a major power
	SEND_VOLUNTEER_EVAL_MAJOER_POWER = 1.0, 	    -- How willing major powers are to send volunteers.
	SEND_VOLUNTEER_EVAL_CONTAINMENT_FACTOR = 0.2, --WAS 0.1 How much AI containment factors into its evaluation of sending volunteers.
	...
	GIVE_STATE_CONTROL_MIN_CONTROL_DIFF = 0.5,	--WAS 2 The difference in number of controlled states compared to war participation needs to be bigger than this for the AI to consider giving a state to a country
	RELATIVE_STRENGTH_TO_INVADE = 0.01,			--WAS 0.06 Compares the estimated strength of the country/faction compared to it's enemies to see if it should invade or stay at home to defend.
	RELATIVE_STRENGTH_TO_INVADE_DEFENSIVE = 0.8,--WAS 0.4 Compares the estimated strength of the country/faction compared to it's enemies to see if it should invade or stay at home to defend, but while being a defensive country.
	GIVE_STATE_CONTROL_BASE_SCORE = 5,			--WAS 50 Base diplo score for giving away control of states
	GIVE_STATE_CONTROL_DIFF_FACTOR = 2.0,		-- Diplo score multiplier for state control compared to war participation difference
	GIVE_STATE_CONTROL_NEIGHBOR_SCORE = 10,		--WAS 20 Diplo score for each neighboring state controlled by the target
	...
	GIVE_STATE_CONTROL_MAX_SCORE_DIST = 400,	--WAS 600 A State that is closer to the recipient capital than this gets a score bonus based on the below value
	GIVE_STATE_CONTROL_DIST_SCORE_MULT = 0.5,	--WAS 0.2 Multiplier for the score gained from distance ( GIVE_STATE_CONTROL_MAX_SCORE_DIST - distance ) * this
	...
	GENERATE_WARGOAL_ANTAGONIZE_SCALE = 0.7,    --WAS 0.35 works to scale the AIs antagonize value vs the threat baseline for when it should act on existing claims: threat used for baseline is min_threat - antagonize * scale
	...
	MAIN_ENEMY_FRONT_IMPORTANCE = 16.0,         --WAS 4.0 How much extra focus the AI should put on who it considers to be its current main enemy.
	EASY_TARGET_FRONT_IMPORTANCE = 7.5,			-- How much extra focus the AI should put on who it considers to be the easiest target.
	AI_FRONT_MOVEMENT_FACTOR_FOR_READY = 0.4,	--WAS 0.25 If less than this fraction of units on a front is moving, AI sees it as ready for action	
	MICRO_POCKET_SIZE = 4,						-- Pockets with a size equal to or lower than this will be mocroed by the AI, for efficiency.
	POCKET_DISTANCE_MAX = 30000,				--WAS 40000 shortest square distance we bother about chasing pockets
	VP_LEVEL_IMPORTANCE_HIGH = 20,				--WAS 25 Victory points with values higher than or equal to this are considered to be of high importance.
	VP_LEVEL_IMPORTANCE_MEDIUM = 10,			--WAS 5 Victory points with values higher than or equal to this are considered to be of medium importance.
	VP_LEVEL_IMPORTANCE_LOW = 5,				--WAS 1 Victory points with values higher than or equal to this are considered to be of low importance.
	ESTIMATED_CONVOYS_PER_DIVISION = 6,			-- Not always correct, but mainly used to make sure AI does not go crazy
	FRONT_REASSIGN_DISTANCE = 220.0,			--WAS 120 If a unit is this far away from a front it is not considered to be assigned to it unless the new front is much more important
	OLD_FRONT_IMPORTANCE_FACTOR = 1,			--WAS 1.50 If a unit is considered for reassignment, the importance of both new and old front is considered with a weight applied to the old ones score
	ENTRENCHMENT_WEIGHT = 4.0,					--WAS 2 AI should favour units with less entrenchment when assigning units around.
	FRONT_TERRAIN_DEFENSE_FACTOR = 2.0,			--WAS 5.0 Multiplier applied to unit defense modifier for terrain on front province multiplied by terrain importance
	FRONT_TERRAIN_ATTACK_FACTOR = 2.0,			--WAS 5.0 Multiplier applied to unit attack modifier for terrain on enemy front province multiplied by terrain importance
	...
	PLAN_FACTION_STRONG_TO_EXECUTE = 0.55,		--WAS 0.50 % or more of units in an order to consider ececuting the plan
	PLAN_FACTION_NORMAL_TO_EXECUTE = 0.55,		--WAS 0.65 % or more of units in an order to consider executing the plan
	PLAN_FACTION_WEAK_TO_ABORT = 0.5,			--WAS 0.65 % or more of units in an order to consider ececuting the plan
	PLAN_AVG_PREPARATION_TO_EXECUTE = 0.2,		--% or more average plan preparation before executing
	STATE_GARRISON_MAX_UNITS = 2,				--WAS 3 Max units to guard a garrison under normal circumstances (isolated core areas like England has is excempt)
	...
	UNIT_ASSIGNMENT_TERRAIN_IMPORTANCE = 10.0,  --WAS 5 Terrain score for units are multiplied by this when the AI is deciding which front they should be assigned to
	...
	FASCISTS_BEFRIEND_FASCISTS = 50,
	FASCISTS_BEFRIEND_DEMOCRACIES = -25,
	FASCISTS_BEFRIEND_COMMUNISTS = -100,
	FASCISTS_ALLY_FASCISTS = 0,
	FASCISTS_ALLY_DEMOCRACIES = -50,           -- Was -100
	...
	DEMOCRACIES_BEFRIEND_COMMUNISTS = -50,    -- Was -25
	...
	COMMUNISTS_BEFRIEND_FASCISTS = -100,       -- Was -25
	...
	COMMUNISTS_ANTAGONIZE_COMMUNISTS = -30,
	...
	DIPLOMACY_FACTION_CIVILWAR_WANTS_HELP = -1000, --WAS -50
	...
	CALL_ALLY_WT_LIMIT = 0.99,                           --WAS 0.8 fascists are hesitant to call allies if tension is lower than this
	CALL_ALLY_FASCIST_DESIRE_WT = -120,                  --WAS -60 less desire if we are below the tension limit

	SHIPS_PRODUCTION_BASE_COST = 10,					--WAS 10000 Used by the AI to normalize IC values when picking what ship to build.
	NEEDED_NAVAL_FACTORIES_EXPENSIVE_SHIP_BONUS = 30,   --WAS 12 Amount of naval yards you need to get a bonus to building really expensive ships

	AIR_WING_REINFORCEMENT_LIMIT = 100,					-- WAS 150
	...
	DESPERATE_AI_MIN_UNIT_ASSIGN_TO_ESCAPE = 10,			--WAS 8 AI will assign at least this amount of units to break from desperate situations
	...
	MANPOWER_FREE_USAGE_THRESHOLD = 1000,				--WAS 500 000 If AI has this much manpower he doesn't care about the percentage
	MANPOWER_RESERVED_THRESHOLD = 0.01,					--WAS 0.25 The AI will not deploy more units if he goes below this percentage
	START_TRAINING_EQUIPMENT_LEVEL = 0.81,              --WAS 0.9 ai will not start to train if equipment drops below this level
	STOP_TRAINING_EQUIPMENT_LEVEL = 0.8,                -- ai will not train if equipment drops below this level
	BUILD_REFINERY_LACK_OF_RESOURCE_MODIFIER = 0.005,	--WAS 0.003 How much lack of resources are worth when evaluating what to build.
	...
	DIVISION_DESIGN_MANPOWER_WEIGHT = 0.001,				--WAS 0.005
	...
	DIVISION_DESIGN_COMBAT_WIDTH_TARGET_WEIGHT = -1000.0,	--WAS -200 This score is reduced the farther the width is from the target width (if set)
	...
	UPGRADE_DIVISION_RELUCTANCE = 10,					--WAS 7 How often to consider upgrading to new templates for units in the field
	UPGRADE_PERCENTAGE_OF_FORCES = 0.05,				--WAS 0.1 How big part of the army that should be considered for upgrading

	STRATEGIC_BOMBING_DEFENCE_IMPORTANCE = 600.0,		-- Was 500
	
	NAVAL_MISSION_MIN_FLEET_SIZE = 1,					-- AI will not send too small fleets on missions. Ignored if total number of ships country has is below	this.
	NAVY_PREFERED_MAX_SIZE = 70,						--WAS 20 AI will generally attempt to merge fleets into this size, but as a soft limit.
	...
	CONVOY_NEED_SAFETY_BUFFER = 1.50,					--WAS 1.30 AI will try and keep 15% more convoys than what it needs.
	REGION_THREAT_PER_SUNK_CONVOY = 50,					--WAS 25 Threat value per convoy sunk in a region. Decays over time.
	...
	PLAN_ACTIVATION_MAJOR_WEIGHT_FACTOR = 1,			--WAS 5 AI countries will hold on activating plans if stronger countries have plans in the same location. Majors count extra (value of 1 will negate this)
	PLAN_ACTIVATION_PLAYER_WEIGHT_FACTOR = 100,			--WAS 50 AI countries will hold on activating plans if player controlled countries have plans in the same location. Majors count extra (value of 1 will negate this)
	AREA_DEFENSE_BASE_IMPORTANCE = 4,					--WAS 3 Area defense order base importance value (used for determining order of troop selections)
	...
	COMBINED_ARMS_LEVEL = 2,							--WAS 1 0 = Never, 1 = Infantry/Artillery, 2 = Go wild
	MAX_DISTANCE_NALAV_INVASION = 150.0,				--WAS 200 AI is extremely unwilling to plan naval invasions above this naval distance limit.
	ENEMY_NAVY_STRENGTH_DONT_BOTHER = 3,				--WAS 2.5 If the enemy has a navy at least these many times stronger that the own, don't bother invading
	MIN_SUPPLY_USE_SANITY_CAP = 200,					--WAS 100 Ignore supply cap if below this value when deciding on how many divisions to produce.
	MAX_SUPPLY_DIVISOR = 5.0,							--WAS 1.75 To make sure the AI does not overdeploy divisions. Higher number means more supply per unit.
	MISSING_CONVOYS_BOOST_FACTOR = 10.0,				--WAS 6 The more convoys a country is missing, the more resources it diverts to cover this.
	TRANSPORTS_PER_PARATROOPER = 20,					-- Air transports only duty is to drop paratroopers.
	MAX_MICRO_ATTACKS_PER_ORDER = 8,					--WAS 3 AI goes through its orders and checks if there are situations to take advantage of
	FALLBACK_LOSING_FACTOR = 1.3,						--WAS 1.0 The lower this number, the longer the AI will hold the line before sending them to the fallback line
	PRODUCTION_MAX_PROGRESS_TTO_SWITCH_NAVAL = 0.1,		--WAS 0.3 AI will not replace ships being built by newer types if progress is above this
	STATE_CONTROL_FOR_AREA_DEFENSE = 0.4,				--To avoid AI sending area defense to area with very little foothold
	FORCE_FACTOR_AGAINST_EXTRA_MINOR = 0.05,			--WAS 0.15 AI considers generating wargoals against minors below this % of force compared to themselves to get at a bigger enemy.
	...
	NAVAL_MISSION_INVASION_BASE = 4000,					--WAS 1000 Base score for region with naval invasion (modified dynamically by prioritizing orders)
	...
	NEW_LEADER_EXTRA_PP_FACTOR = 100,					--WAS 2 Country must have at least this many times extra PP to get new admirals or army leaders
	SCARY_LEVEL_AVERAGE_DEFENSE = -0.61,                --WAS -0.7 average front defense modifier to make it consider it as a PITA to go for
	ATTACK_HEAVILY_DEFENDED_LIMIT = 0.4,				--WAS 0.5 AI will not launch attacks against heavily defended fronts unless they consider to have this level of advantage (1.0 = 100%)
	HOUR_BAD_COMBAT_REEVALUATE = 36,                    --WAS 168 if we are in combat for this amount and it goes shitty then try skipping it 
	...
	MAX_UNITS_FACTOR_AREA_ORDER = 2.0,					--WAS 1.0 Factor for max number of units to assign to area defense orders
	DESIRED_UNITS_FACTOR_AREA_ORDER = 1.0,				-- Factor for desired number of units to assign to area defense orders
	MIN_UNITS_FACTOR_AREA_ORDER = 1.0,					--WAS 1.0 Factor for min number of units to assign to area defense orders

	MAX_UNITS_FACTOR_FRONT_ORDER = 3.0,					--WAS 1.5 Factor for max number of units to assign to area front orders
	DESIRED_UNITS_FACTOR_FRONT_ORDER = 3.0,				--WAS 1.5 Factor for desired number of units to assign to area front orders
	MIN_UNITS_FACTOR_FRONT_ORDER = 1.0,					--WAS 1.0 Factor for min number of units to assign to area front orders

	MAX_UNITS_FACTOR_INVASION_ORDER = 0.5,				--WAS 1.0 Factor for max number of units to assign to naval invasion orders
	DESIRED_UNITS_FACTOR_INVASION_ORDER = 0.5,			--WAS 1.0 Factor for desired number of units to assign to naval invasion orders
	MIN_UNITS_FACTOR_INVASION_ORDER = 0.5,				--WAS 1.0 Factor for min number of units to assign to naval invasion orders
	
	FRONT_UNITS_CAP_FACTOR = 30.0,						--WAS 15 A factor applied to total front size and supply use. Primarily effects small fronts
	MAX_DIST_PORT_RUSH = 25.0,							--WAS 20.0 If a unit is in enemy territory with no supply it will consider nearby ports within this distance.
	
	MIN_FIELD_STRENGTH_TO_BUILD_UNITS = 0.04,			--WAS 0.7 Cancel unit production if below this to get resources out to units in the field
	MIN_MANPOWER_TO_BUILD_UNITS = 0.05,					--WAS 0.7 Cancel unit production if below this to get resources out to units in the field
	...
	REQUEST_LEND_LEASE_CONTAINS_VALUE = 150,			--WAS 100 Limit of contain enemy desire for boosting friendly help
	...
	AIR_SUPERIORITY_MISSION_FACTOR = 1.5,				--WAS 1.0 AI air superiority mission factor
	CAS_MISSION_FACTOR = 1.4,							-- AI cas mission factor
	INTERCEPTION_MISSION_FACTOR = 1,					--WAS 0.5 AI interception mission factor
	...
	LAND_DEFENSE_AIR_SUPERIORITY_IMPORTANCE = 0.20,		--WAS 0.10 Strategic importance of air superiority ( amount of enemy planes in area )
	...
	LAND_COMBAT_AIR_SUPERIORITY_IMPORTANCE = 0.50,		--WAS 0.20 Strategic importance of air superiority ( amount of enemy planes in area )
	LAND_COMBAT_OUR_ARMIES_AIR_IMPORTANCE = 12,			-- Strategic importance of our armies
	LAND_COMBAT_OUR_COMBATS_AIR_IMPORTANCE = 80,		--WAS 55 Strategic importance of our armies in the combats
	...
	LAND_COMBAT_IMPORTANCE_SCALE = 15,					--WAS 1.5 Lend combat total importance scale (every land combat score get's multiplied by it)
	
	LAND_COMBAT_FIGHTERS_PER_PLANE = 1.5,				--WAS 1.1 Amount of air superiority planes requested per enemy plane
	...
	LAND_COMBAT_CAS_PER_COMBAT = 300,					--WAS 200 Amount of CAS requested per combat	


	LAND_COMBAT_BOMBERS_PER_LAND_FORT_LEVEL = 30,		--WAS 15 Amount of bomber planes requested per enemy land fort level
	LAND_COMBAT_BOMBERS_PER_COASTAL_FORT_LEVEL = 20,	--WAS 10 Amount of bomber planes requested per enemy coastal fort level
	...
	STR_BOMB_MIN_ENEMY_FIGHTERS_IN_AREA = 500,			--WAS 300 If amount of enemy fighters is higher than this mission won't perform
	STR_BOMB_FIGHTERS_PER_PLANE = 1.5,					--WAS 1.1 Amount of air superiority planes requested per enemy plane
	...
	REVISITED_PROV_PENALTY_FACTOR = 2,					--WAS 1.5 When the AI picks units for a front, it tries to spread out a bit which units it grabs.
	
	PLAN_ACTIVATION_SUPERIORITY_AGGRO = 50,				--WAS 1.0 How aggressive a country is in activating a plan based on how superiour their force is.
	WAIT_YEARS_BEFORE_FREER_BUILDING = 0,				--WAS 3 The AI will skip considering certain buildings during the buildup phase, after htese many years it starts building them regardless of threat.
	...
	DOCKYARDS_PER_NAVAL_DESIRE_EFFECT = -50.0,			--WAS -20 Effects how much AI wants to build dockyards based on how navally focused they are in general. Recommended range -100.0 to 100.0.
	...
	LOW_PRIO_TEMPLATE_BONUS_FOR_GARRISONS = 20000,		--WAS 10000 bonus to make ai more likely to assign low prio units to garrisons
	LOW_PRIO_TEMPLATE_PENALTY_FOR_FRONTS = 20000,		--WAS 10000 penalty to make ai less likely to assign low prio units to fronts
	
	DEPLOYED_UNIT_MANPOWER_RATIO_TO_BUFFER_WARTIME = 0.2, 				--WAS 0.3 deployment will try to buffer a ratio of deployed manpower (for reinforcements) during war time
	...
	MAX_AVAILABLE_MANPOWER_RATIO_TO_BUFFER_WARTIME = 0.3,		--WAS 0.4 deployment will try to buffer a ratio of manpower (for reinforcements) during war time
	...
	MANPOWER_RATIO_REQUIRED_TO_PRIO_MOBILIZATION_LAW = 0.3,		--WAS 0.4 percentage of manpower in field is desired to be buffered for AI when it has upcoming wars or already at war. if it has less manpower, it will prio manpower laws
	UPGRADES_DEFICIT_LIMIT_DAYS = 500,                          --WAS 50 Ai will avoid upgrading units in the field to new templates if it takes longer than this to fullfill their equipment need
