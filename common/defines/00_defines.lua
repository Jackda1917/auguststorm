...
NDiplomacy = {
	...
	BASE_IMPROVE_RELATION_DIFFERENT_IDEOLOGY_GROUP_MAINTAIN_COST = 0.7,    --WAS 0.4 Political power cost each update when boosting relations with nation of different ideology
	...
	TENSION_CB_WAR = 7,							--WAS 5 Amount of tension generated by a war with a CB
	...
	TENSION_JOIN_ATTACKER = 8,						--WAS 2 scale of the amount of tension added when country joins attacker side
...
NCountry = {
	...
	SUPPLY_PATH_MAX_DISTANCE = 20,					--WAS 15 When supply route reach more than X nodes, the manpower+equipment delivery speed reach 100% penalty.
	POPULATION_YEARLY_GROWTH_BASE = 0.025,			--WAS 0.015 basic population growth per year, used for monthly manpower gain
	...
	WAR_SUPPORT_TENSION_IMPACT = 0.4,				--WAS 0.3 Total impact of world tension
	MIN_STABILITY = 0.0,
	MAX_STABILITY = 1.0,
	MIN_WAR_SUPPORT = 0.0,
	MAX_WAR_SUPPORT = 1.0,
	...
	CIVIL_WAR_INVOLVEMENT_MIN_TENSION = 0.7,		--WAS 0.5 base value of world tension to involve other sides to the civil war
...
NProduction = {
	...
	ANNEX_STOCKPILES_RATIO = 0.90,		--WAS 1.0 How much stockpiled equipment will be transferred on annexation
...
NMilitary = {
	COMBAT_VALUE_ORG_IMPORTANCE = 1.25,		--WAS 1 Multiplier on TotalOrganisation when determining the combat value of a division
	COMBAT_VALUE_STR_IMPORTANCE = 1,		--WAS 1 Multiplier on TotalStrength when determining the combat value of a division
	
	HOURLY_ORG_MOVEMENT_IMPACT = -0.3,		--WAS -0.2 how much org is lost every hour while moving an army.
	...
	CORPS_COMMANDER_DIVISIONS_CAP = 12,			--WAS 24 how many divisions a corps commander is limited to. 0 = inf, < 0 = blocked
	...
	RECON_SKILL_IMPACT = 4, --WAS 5 how many skillpoints is a recon advantage worth when picking a tactic.
	...
	LAND_COMBAT_STR_DAMAGE_MODIFIER = 0.06,        --WAS 0.05 global damage modifier
	...
	LAND_COMBAT_STR_ARMOR_ON_SOFT_DICE_SIZE = 3,   --WAS 2 extra damage dice if our armor outclasses enemy
	LAND_COMBAT_ORG_ARMOR_ON_SOFT_DICE_SIZE = 8,   --WAS 5 -- extra damage dice if our armor outclasses enemy
	LAND_COMBAT_STR_ARMOR_DEFLECTION_FACTOR = 1, --WAS 0.5 damage reduction if armor outclassing enemy
	LAND_COMBAT_ORG_ARMOR_DEFLECTION_FACTOR = 1.5, --WAS 0.5 damage reduction if armor outclassing enemy
	...
	ATTRITION_WHILE_MOVING_FACTOR = 0.8,			-- WAS 1
	BASE_CHANCE_TO_AVOID_HIT = 85,                 --WAS 90 Base chance to avoid hit if defences left.
	CHANCE_TO_AVOID_HIT_AT_NO_DEF = 55,	           --WAS 60 chance to avoid hit if no defences left.
	...
	LAND_SPEED_MODIFIER = 0.04,                    --WAS 0.05 basic speed control
	...
	DIG_IN_FACTOR = 0.04,						   --WAS 0.02 bonus factor for each dug-in level
	LEADER_SKILL_FACTOR = 0.07,                     --WAS 0.05 bonus per skill level of leader
	...
	BASE_LEADER_TRAIT_GAIN_XP = 0.85,			   --WAS 1 Base xp gain for traits per hour.
	...
	EQUIPMENT_COMBAT_LOSS_FACTOR = 0.75,	 	   --WAS 0.7 % of equipment lost to strength ratio in combat, so some % is returned if below 1
	...
	REINFORCE_CHANCE = 0.04,                 	   --WAS 0.02 base chance to join combat from back line when empty
	...
	LOW_ORG_FOR_ATTACK = 0.4,                      --WAS 0.5 at what org % we start affecting speed when doign hostile moves. scales down ZERO_ORG_MOVEMENT_MODIFIER
	...
	CIVILWAR_ORGANIZATION_FACTOR = 0.15,			--WAS 0.3 Multiplier of org for both sides when civilwar.
	...
	PLAN_MIN_AUTOMATED_EMPTY_POCKET_SIZE = 1,		--WAS 2 The battle plan system will only automatically attack provinces in pockets that has no resistance and are no bigger than these many provinces
	PLAN_SPREAD_ATTACK_WEIGHT = 8.0,				--WAS 13.0 The higher the value, the less it should crowd provinces with multiple attacks.
	PLAN_SUPPLY_FACTOR = 0.2,						--WAS 0.1 Factor applied to available supply on a front location when determining priority
	PLAN_NEIGHBORING_ENEMY_PROVINCE_FACTOR = 0.9,	--WAS 0.7 When calculating the importance of provinces, it takes number of enemy provinces into account, factored by this
	PLAN_PROVINCE_BASE_IMPORTANCE = 1.0,			--WAS 2 Used when calculating the calue of front and defense area provinces for the battle plan system
	...
	PLAN_PROVINCE_HIGH_VP_IMPORTANCE_FRONT = 9.0,   --WAS 5.0 Used when calculating the calue of fronts in the battle plan system
	...
	PLAN_EXECUTE_CAREFUL_LIMIT = 30,				--WAS 25 When looking for an attach target, this score limit is required in the battle plan to consider province for attack
	...
	PLAN_MAX_PROGRESS_TO_JOIN = 0.25,				--WAS 0.5 If Lower progress than this, probably needs support

	PLAN_BLITZ_OPTIMISM = 0.3,						--WAS 0.2 Additional combat balance value in favor of blitzing side when considering targets (not a combat bonus, just offsets planning)
	...
	XP_GAIN_FOR_SHATTERING = 30.0,                          -- extra multiplier on XP gain on shattering an encircled enemy
},
...
NNavy = {
	...
	EXPERIENCE_FACTOR_CARRIER_GAIN = 0.15,							--WAS 0.1 Xp gain by carrier ships in the combat
...
NTrade = {
	...
	MONTH_TRADE_FACTOR = 10,				--WAS 2 Each month a trade gets this much boost to it's trade factor
	MAX_MONTH_TRADE_FACTOR = 100,			--WAS 50 This is the maximum bonus that can be gained from time
	BASE_TRADE_FACTOR = 150,				-- This is the base trade factor
	PUPPET_MASTER_TRADE_FACTOR = 700,		--WAS 400 This is priority for puppet master
...
NAI = {
	...
	DIPLOMACY_FACTION_WRONG_IDEOLOGY_PENALTY = 30, --WAS 60 AI penalty for diplomatic faction acitons between nations of different ideologies
	DIPLOMACY_FACTION_SAME_IDEOLOGY_MAJOR = 10, --WAS 10 AI bonus acceptance when being asked about faction is a major of the same ideology
	...
	DIPLOMACY_FACTION_GLOBAL_TENSION_FACTOR = 0.3,--WAS 0.2 How much the AI takes global tension into account when considering faction actions
	...
	DIPLOMACY_REJECTED_WAIT_MONTHS_BASE = 2,	--WAS 4 AI will not repeat offers until at least this time has passed, and at most the double
	DIPLOMACY_SEND_MAX_FACTION = 0.60,			--WAS 0.75 Country should not send away more units than this as expeditionaries
	...
	RESEARCH_NAVAL_DOCTRINE_NEED_GAIN_FACTOR = 0.5, --WAS 0.075 (1.1) Multiplies value based on relative naval industry size / country size.
	RESEARCH_AIR_DOCTRINE_NEED_GAIN_FACTOR = 0.8, --WAS 0.08 Multiplies value based on relative number of air base / country size.
	...
	NAVAL_DOCKYARDS_SHIP_FACTOR = 2.2,			--WAS 1.5 The extent to which number of dockyards play into amount of sips a nation wants
	NAVAL_BASES_SHIP_FACTOR = 0.75,				--WAS 0.75 The extent to which number of naval bases play into amount of sips a nation wants
	NAVAL_STATES_SHIP_FACTOR = 0.33,			--WAS 0.75 The extent to which number of states play into amount of sips a nation wants
	...
	PRODUCTION_EQUIPMENT_SURPLUS_FACTOR = 0.2,	--WAS 0.25 Base value for how much of currently used equipment the AI will at least strive to have in stock
	...
	WANTED_UNITS_INDUSTRY_FACTORY = 2.5, 		--WAS 1.0 How many units a country wants is partially based on how much military industry that is available
	...
	DYNAMIC_STRATEGIES_THREAT_FACTOR = 3.0,		--WAS 4.0 How much threat generated by other countries effects generated strategies
	...
	DIVISION_CREATE_MIN_XP = 5000,				--WAS 100 Minimum XP before attempting to create a fresh new division template.
	...
	VP_GARRISON_VALUE_FACTOR = 0.98,			--WAS 0.75 Extent to which VP garrisons are prioritized, based on VP value and compared to other priority values.
	PLAN_VALUE_TO_EXECUTE = -0.6,				--WAS -0.5 AI will typically avoid carrying out a plan it below this value (0.0 is considered balanced).
	...
	LENDLEASE_FRACTION_OF_PRODUCTION = 0.15,	--WAS 0.5 Base fraction AI would send as lendlease
	...
	NEIGHBOUR_WAR_THREAT_FACTOR = 1.35, 		--WAS 1.10 How much increase in threat does AI feel against neighbours who are at war
	POTENTIAL_ALLY_JOIN_WAR_FACTOR = 150, 		--WAS 100 How much increase in threat does AI feel against neighbours who are allied against one of our enemies
	POTENTIAL_FUTURE_ENEMY_FACTOR = 150, 		--WAS 100 How much increase in threat does AI feel against neighbours who at war with our allies
	...
	PLAN_FRONT_SECTION_MAX_LENGTH = 15,			--WAS 18 When a front is longer than this it will be split in two sections for the AI
	PLAN_FRONT_SECTION_MIN_LENGTH = 8,			--WAS 10 When two front sections together are this short they will be merged for the AI
	PLAN_MIN_SIZE_FOR_FALLBACK = 25,			--WAS 50 A country with less provinces than this will not draw fallback plans, but rather station their troops along the front
	...
	SEND_VOLUNTEER_EVAL_CONTAINMENT_FACTOR = 0.15, --WAS 0.1 How much AI containment factors into its evaluation of sending volunteers.
	...
	RELATIVE_STRENGTH_TO_INVADE = 0.15,			--WAS 0.06 Compares the estimated strength of the country/faction compared to it's enemies to see if it should invade or stay at home to defend.
	...
	MAIN_ENEMY_FRONT_IMPORTANCE = 8.0,         --WAS 4.0 How much extra focus the AI should put on who it considers to be its current main enemy.
	EASY_TARGET_FRONT_IMPORTANCE = 10.0,		--WAS 7.5 How much extra focus the AI should put on who it considers to be the easiest target.
	AI_FRONT_MOVEMENT_FACTOR_FOR_READY = 0.5,	--WAS 0.25 If less than this fraction of units on a front is moving, AI sees it as ready for action	
	MICRO_POCKET_SIZE = 4,						-- Pockets with a size equal to or lower than this will be mocroed by the AI, for efficiency.
	POCKET_DISTANCE_MAX = 15000,				--WAS 40000 shortest square distance we bother about chasing pockets
	...
	OLD_FRONT_IMPORTANCE_FACTOR = 1.75,			--WAS 1.50 If a unit is considered for reassignment, the importance of both new and old front is considered with a weight applied to the old ones score
	ENTRENCHMENT_WEIGHT = 25.0,					--WAS 2 AI should favour units with less entrenchment when assigning units around.
	FRONT_TERRAIN_DEFENSE_FACTOR = 20.0,		--WAS 5.0 Multiplier applied to unit defense modifier for terrain on front province multiplied by terrain importance
	FRONT_TERRAIN_ATTACK_FACTOR = 20.0,			--WAS 5.0 Multiplier applied to unit attack modifier for terrain on enemy front province multiplied by terrain importance
	...
	PLAN_FACTION_STRONG_TO_EXECUTE = 0.45,		--WAS 0.50 % or more of units in an order to consider ececuting the plan
	PLAN_FACTION_NORMAL_TO_EXECUTE = 0.65,		-- % or more of units in an order to consider executing the plan
	PLAN_FACTION_WEAK_TO_ABORT = 0.55,			--WAS 0.65 % or more of units in an order to consider ececuting the plan
	PLAN_AVG_PREPARATION_TO_EXECUTE = 0.3,		--WAS 0.2 % or more average plan preparation before executing
	STATE_GARRISON_MAX_UNITS = 4,				--WAS 3 Max units to guard a garrison under normal circumstances (isolated core areas like England has is excempt)
	...
	UNIT_ASSIGNMENT_TERRAIN_IMPORTANCE = 30.0, --WAS 5 Terrain score for units are multiplied by this when the AI is deciding which front they should be assigned to
	...
	COMMUNISTS_BEFRIEND_FASCISTS = -50,       -- Was -25
	...
	DIPLOMACY_FACTION_CIVILWAR_WANTS_HELP = -500, --WAS -50
	...
	NEEDED_NAVAL_FACTORIES_EXPENSIVE_SHIP_BONUS = 15,   --WAS 12 Amount of naval yards you need to get a bonus to building really expensive ships

	AIR_WING_REINFORCEMENT_LIMIT = 50,					-- WAS 150
	...
	MANPOWER_FREE_USAGE_THRESHOLD = 300000,			--WAS 500 000 If AI has this much manpower he doesn't care about the percentage
	MANPOWER_RESERVED_THRESHOLD = 0.35,					--WAS 0.25 The AI will not deploy more units if he goes below this percentage
	...
	BUILD_REFINERY_LACK_OF_RESOURCE_MODIFIER = 0.001,	--WAS 0.003 How much lack of resources are worth when evaluating what to build.
	...
	UPGRADE_DIVISION_RELUCTANCE = 50,					--WAS 7 How often to consider upgrading to new templates for units in the field
	UPGRADE_PERCENTAGE_OF_FORCES = 0.01,				--WAS 0.1 How big part of the army that should be considered for upgrading
	...
	NAVY_PREFERED_MAX_SIZE = 35,						--WAS 20 AI will generally attempt to merge fleets into this size, but as a soft limit.
	...
	ENEMY_NAVY_STRENGTH_DONT_BOTHER = 2,				--WAS 2.5 If the enemy has a navy at least these many times stronger that the own, don't bother invading
	...
	MAX_SUPPLY_DIVISOR = 35.0,							--WAS 1.75 To make sure the AI does not overdeploy divisions. Higher number means more supply per unit.
	...
	NEW_LEADER_EXTRA_PP_FACTOR = 9999,					--WAS 2 Country must have at least this many times extra PP to get new admirals or army leaders
	SCARY_LEVEL_AVERAGE_DEFENSE = -0.61,                 --WAS -0.7 average front defense modifier to make it consider it as a PITA to go for
	ATTACK_HEAVILY_DEFENDED_LIMIT = 0.7,				--WAS 0.5 AI will not launch attacks against heavily defended fronts unless they consider to have this level of advantage (1.0 = 100%)
	HOUR_BAD_COMBAT_REEVALUATE = 25,                    --WAS 168 if we are in combat for this amount and it goes shitty then try skipping it 
	...
	MIN_FIELD_STRENGTH_TO_BUILD_UNITS = 0.4,			--WAS 0.7 Cancel unit production if below this to get resources out to units in the field
	MIN_MANPOWER_TO_BUILD_UNITS = 0.5,					--WAS 0.7 Cancel unit production if below this to get resources out to units in the field
	...
	LAND_COMBAT_AIR_SUPERIORITY_IMPORTANCE = 0.40,		--WAS 0.20 Strategic importance of air superiority ( amount of enemy planes in area )
	...
	LAND_COMBAT_FIGHTERS_PER_PLANE = 1.25,				--WAS 1.1 Amount of air superiority planes requested per enemy plane
	...
	PLAN_ACTIVATION_SUPERIORITY_AGGRO = 1.25,			--WAS 1.0 How aggressive a country is in activating a plan based on how superiour their force is.
