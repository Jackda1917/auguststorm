...
NDiplomacy = {
	...
	BASE_SURRENDER_LEVEL = 0.9,						--WAS 1.0 Surrender when level reached. valid 0-1
	...
	BASE_PEACE_TAKE_FACTION_CONTROLLED_STATE_FACTOR = 0.25, --WAS 0.5 Base factor for taking state you do not control, but someone in faction does
	...
	TENSION_NO_CB_WAR = 20,							--WAS 15 Amount of tension generated by a no-CB war
	TENSION_CB_WAR = 6,							--WAS 5 Amount of tension generated by a war with a CB
	...
	TAKE_STATES_GIVE_CORE_TO_SUBJECT_MULT = 0.01,	--WAS 0.1 Cost multiplier for feeding core states to a subject 
	...
	LL_TO_PUPPET_AUTONOMY_DAILY_BASE = 0.0001,		--WAS 0 If overlord lend leases equipment to puppet of higher tech level as they have, puppet losses autonomy
	...
	LICENSE_ACCEPTANCE_SAME_FACTION = 40,			--WAS 20 Acceptance modifier for being in the same faction
},
...
NCountry = {
	...
	POPULATION_YEARLY_GROWTH_BASE = 0.03,			--WAS 0.015 basic population growth per year, used for monthly manpower gain
	...
	MAX_NATIONAL_UNITY = 0.90,                      --WAS 0.95
	...
	VICTORY_POINTS_IMPORTANCE_FACTOR = 10.0,			--WAS 5.0 State victory points importance factor for AI and calculations
...
NProduction = {
	...
	BASE_FACTORY_SPEED_NAV = 2, 				--WAS 2.5 Base factory speed multiplier (how much hoi3 style IC each factory gives).
	...
	BASE_FACTORY_EFFICIENCY_GAIN = 0.12,		--WAS 1 -- Base efficiency gain for factories per unit produced in %.
...
NTechnology = {
	...
	MAX_TECH_SHARING_BONUS = 0.4, 			--WAS 0.5 Max technology sharing bonus that can be applied instantly
...
NMilitary = {
	...
	LAND_AIR_COMBAT_MAX_PLANES_PER_ENEMY_WIDTH = 5, --WAS 3 how many CAS/TAC can enter a combat depending on enemy width there
	...
	LAND_COMBAT_STR_ARMOR_DEFLECTION_FACTOR = 0.8, --WAS 0.5 damage reduction if armor outclassing enemy
	LAND_COMBAT_ORG_ARMOR_DEFLECTION_FACTOR = 0.7, --WAS 0.5 damage reduction if armor outclassing enemy
	...
	CHANCE_TO_AVOID_HIT_AT_NO_DEF = 50,	           --WAS 60 chance to avoid hit if no defences left.
	...
	DIG_IN_FACTOR = 0.06,						   --WAS 0.02 bonus factor for each dug-in level
	...
	SUPPLY_USE_FACTOR_MOVING = 2.0,                --WAS 1.5 supply use when moving/fighting vs inactive
	SUPPLY_USE_FACTOR_INACTIVE = 0.50,             --WAS 0.95
	...
	PLAN_SPREAD_ATTACK_WEIGHT = 30.0,				--WAS 13.0 The higher the value, the less it should crowd provinces with multiple attacks.
	...
	PLAN_PROVINCE_HIGH_VP_IMPORTANCE_AREA = 70.0,   --WAS 50.0 Used when calculating the calue of defense area in the battle plan system
	...
	PLAN_PORVINCE_PORT_BASE_IMPORTANCE = 12.0,		--WAS 9.0 Added importance for area defense province with a port
	...
	PLAN_PORVINCE_AIRFIELD_POPULATED_FACTOR = 2,	--WAS 1.5 Bonus factor when an airfield has planes on it
	...
	PLAN_AREA_DEFENSE_FORT_IMPORTANCE = 0.85,		  --WAS 0.25 Used when calculating the calue of defense area provinces for the battle plan system, works as multipliers on the rest
	PLAN_AREA_DEFENSE_COASTAL_FORT_IMPORTANCE = 100.0, --was 5 Used when calculating the calue of defense area provinces for the battle plan system
	...
	PLAN_MAX_PROGRESS_TO_JOIN = 0.45,				--WAS 0.5 If Lower progress than this, probably needs support

	PLAN_BLITZ_OPTIMISM = 0.5,						--WAS 0.2 Additional combat balance value in favor of blitzing side when considering targets (not a combat bonus, just offsets planning)
	...
	LAND_EQUIPMENT_BASE_COST = 10,					--WAS 5 (1.1) Cost in XP to upgrade a piece of equipment one level is base + ( total levels * ramp )
	...
	SLOWER_ORG_REGAIN_LEVEL = 0.70,					-- Was 0.75
...
NAir = {
	...
	DETECT_CHANCE_FROM_AIRCRAFTS = 0.07,				--WAS 0.08 How much aircrafts in region improves air detection (up to effective count).
	...
	ACCIDENT_CHANCE_BASE = 0.1,							--WAS 0.05 Base chance % (0 - 100) for accident to happen. Reduced with higher reliability stat.
	ACCIDENT_CHANCE_CARRIER_MULT = 3.0,					--WAS 2.0 The total accident chance is scaled up when it happens on the carrier ship.
...
NNavy = {
	...
	UNIT_EXPERIENCE_PER_COMBAT_HOUR = 20,							-- WAS 10
	...
	DECRYPTION_SPOTTING_BONUS = 0.4,								-- WAS 0.2
	DISBAND_MANPOWER_LOSS = 0.0,
    },

NTrade = {
	DISTANCE_TRADE_FACTOR = -0.005,			--WAS -0.02 Trade factor is modified by distance times this
...
NAI = {
	GARRISON_FRACTION = 0.1, 					--WAS 0.0 How large part of a front should always be holding the line rather than advancing at the enemy
	...
	RESEARCH_NAVAL_DOCTRINE_NEED_GAIN_FACTOR = 0.06, --WAS 0.075 (1.1) Multiplies value based on relative naval industry size / country size.
	RESEARCH_AIR_DOCTRINE_NEED_GAIN_FACTOR = 0.1, --WAS 0.08 Multiplies value based on relative number of air base / country size.
	...
	RESEARCH_BASE_DAYS = 30,					--WAS 60 AI adds a base number of days when weighting completion time for techs to ensure it doesn't only research quick techs
	...
	NAVAL_DOCKYARDS_SHIP_FACTOR = 2,			--WAS 1.5 The extent to which number of dockyards play into amount of sips a nation wants
	NAVAL_BASES_SHIP_FACTOR = 0.75,				--WAS 0.75 The extent to which number of naval bases play into amount of sips a nation wants
	NAVAL_STATES_SHIP_FACTOR = 0.25,			--WAS 0.75 The extent to which number of states play into amount of sips a nation wants
	...
	INTERCEPT_NAVAL_BOMBING_FACTOR = 50.0,		--WAS 35 Factors the weight of intercepting naval bombers in sea regions where friendly ships are
	...
	DEPLOY_MIN_TRAINING_WAR_FACTOR = 0,			--WAS 0.30 Required percentage of training (1.0 = 100%) for AI to deploy unit in wartime
	DEPLOY_MIN_EQUIPMENT_PEACE_FACTOR = 1.0,	--WAS 0.95 Required percentage of equipment (1.0 = 100%) for AI to deploy unit in peacetime
	DEPLOY_MIN_EQUIPMENT_WAR_FACTOR = 0.90,		--WAS 0.95 Required percentage of equipment (1.0 = 100%) for AI to deploy unit in wartime
	DYNAMIC_STRATEGIES_THREAT_FACTOR = 5.0,		--WAS 4.0 How much threat generated by other countries effects generated strategies
	...
	DIVISION_UPGRADE_MIN_XP = 2,				--WAS 5 Minimum XP before attempting to upgrade a division template.
	...
	VP_GARRISON_VALUE_FACTOR = 0.85,			--WAS 0.75 Extent to which VP garrisons are prioritized, based on VP value and compared to other priority values.
	PLAN_VALUE_TO_EXECUTE = 0.05,				--WAS -0.5 AI will typically avoid carrying out a plan it below this value (0.0 is considered balanced).
	...
	CALL_ALLY_DEMOCRATIC_DESIRE = -195,			--WAS 50 Desire to call ally added for democratic AI
	CALL_ALLY_NEUTRAL_DESIRE = 25,				-- Desire to call ally added for neutral AI
	CALL_ALLY_FASCIST_DESIRE = -195,			-- WAS -10 Desire to call ally added for fascist AI
	...
	JOIN_ALLY_FASCIST_DESIRE = -50,				--WAS -10 Desire to join ally added for fascist AI
	...
	PLAN_STEP_COST_LIMIT_REDUCTION = 20,		--WAS 3 Cost limit is reduced per iteration, making hard terrain less likely to be crossed the further into enemy territory it is
	...
	PLAN_MIN_SIZE_FOR_FALLBACK = 20,			--WAS 50 A country with less provinces than this will not draw fallback plans, but rather station their troops along the front
	...
	SEND_VOLUNTEER_EVAL_CONTAINMENT_FACTOR = 0.8, --WAS 0.1 How much AI containment factors into its evaluation of sending volunteers.
	...
	GIVE_STATE_CONTROL_MIN_CONTROL_DIFF = 1,	--WAS 2 The difference in number of controlled states compared to war participation needs to be bigger than this for the AI to consider giving a state to a country
	RELATIVE_STRENGTH_TO_INVADE = 0.08,			--WAS 0.06 Compares the estimated strength of the country/faction compared to it's enemies to see if it should invade or stay at home to defend.
	RELATIVE_STRENGTH_TO_INVADE_DEFENSIVE = 0.5,--WAS 0.4 Compares the estimated strength of the country/faction compared to it's enemies to see if it should invade or stay at home to defend, but while being a defensive country.
	...
	MAIN_ENEMY_FRONT_IMPORTANCE = 12.0,          --WAS 4.0 How much extra focus the AI should put on who it considers to be its current main enemy.
	EASY_TARGET_FRONT_IMPORTANCE = 25.0,			--WAS 7.5 How much extra focus the AI should put on who it considers to be the easiest target.
	AI_FRONT_MOVEMENT_FACTOR_FOR_READY = 0.3,	--WAS 0.25 If less than this fraction of units on a front is moving, AI sees it as ready for action	
	...
	VP_LEVEL_IMPORTANCE_HIGH = 30,				--WAS 25 Victory points with values higher than or equal to this are considered to be of high importance.
	...
	ENTRENCHMENT_WEIGHT = 3.0,					--WAS 2.0 AI should favour units with less entrenchment when assigning units around.
	FRONT_TERRAIN_DEFENSE_FACTOR = 10.0,		--WAS 5.0 Multiplier applied to unit defense modifier for terrain on front province multiplied by terrain importance
	FRONT_TERRAIN_ATTACK_FACTOR = 10.0,			--WAS 5.0 Multiplier applied to unit attack modifier for terrain on enemy front province multiplied by terrain importance
	...
	PLAN_FACTION_STRONG_TO_EXECUTE = 0.40,		--WAS 0.50 % or more of units in an order to consider ececuting the plan
	PLAN_FACTION_WEAK_TO_ABORT = 0.50,			--WAS 0.65 % or more of units in an order to consider ececuting the plan
	...
	UNIT_ASSIGNMENT_TERRAIN_IMPORTANCE = 1000.0, --WAS 5 Terrain score for units are multiplied by this when the AI is deciding which front they should be assigned to
	...
	MANPOWER_RESERVED_THRESHOLD = 0.50,					--WAS 0.25 The AI will not deploy more units if he goes below this percentage
	...
	NAVY_PREFERED_MAX_SIZE = 25,						--WAS 20 AI will generally attempt to merge fleets into this size, but as a soft limit.
	...
	MAX_DISTANCE_NALAV_INVASION = 250.0,				--WAS 200 AI is extremely unwilling to plan naval invasions above this naval distance limit.
	...
	MAX_SUPPLY_DIVISOR = 2.0,							--WAS 1.75 To make sure the AI does not overdeploy divisions. Higher number means more supply per unit.
	...
	MAX_MICRO_ATTACKS_PER_ORDER = 6,					--WAS 3 AI goes through its orders and checks if there are situations to take advantage of
	FALLBACK_LOSING_FACTOR = 1.25,						--WAS 1.0 The lower this number, the longer the AI will hold the line before sending them to the fallback line
	PRODUCTION_MAX_PROGRESS_TTO_SWITCH_NAVAL = 0,		--WAS 0.3 AI will not replace ships being built by newer types if progress is above this
	STATE_CONTROL_FOR_AREA_DEFENSE = 0.4,				--To avoid AI sending area defense to area with very little foothold
	FORCE_FACTOR_AGAINST_EXTRA_MINOR = 0.10,			--WAS 0.15 AI considers generating wargoals against minors below this % of force compared to themselves to get at a bigger enemy.
	...
	NEW_LEADER_EXTRA_PP_FACTOR = 99999,					--WAS 2 Country must have at least this many times extra PP to get new admirals or army leaders
	SCARY_LEVEL_AVERAGE_DEFENSE = -0.4,                 --WAS -0.7 average front defense modifier to make it consider it as a PITA to go for
	ATTACK_HEAVILY_DEFENDED_LIMIT = 0.55,				--WAS 0.5 AI will not launch attacks against heavily defended fronts unless they consider to have this level of advantage (1.0 = 100%)
	...
	DESIRED_UNITS_FACTOR_AREA_ORDER = 0.5,				--WAS 1.0 Factor for desired number of units to assign to area defense orders
	MIN_UNITS_FACTOR_AREA_ORDER = 0.5,					--WAS 1.0 Factor for min number of units to assign to area defense orders
	...
	MIN_UNITS_FACTOR_FRONT_ORDER = 2.0,					--WAS 1.0 Factor for min number of units to assign to area front orders

	MAX_UNITS_FACTOR_INVASION_ORDER = 0.25,				--WAS 1.0 Factor for max number of units to assign to naval invasion orders
	DESIRED_UNITS_FACTOR_INVASION_ORDER = 0.1,			--WAS 1.0 Factor for desired number of units to assign to naval invasion orders
	MIN_UNITS_FACTOR_INVASION_ORDER = 0.1,				--WAS 1.0 Factor for min number of units to assign to naval invasion orders
	
	FRONT_UNITS_CAP_FACTOR = 15.0,						-- A factor applied to total front size and supply use. Primarily effects small fronts
	MAX_DIST_PORT_RUSH = 30.0,							--WAS 20.0 If a unit is in enemy territory with no supply it will consider nearby ports within this distance.
