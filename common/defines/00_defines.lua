...
NDiplomacy = {
	...
	BASE_IMPROVE_RELATION_COST = 15,                --WAS 10 Political power cost to initiate relation improvement
	BASE_IMPROVE_RELATION_SAME_IDEOLOGY_GROUP_MAINTAIN_COST = 0.4, --WAS 0.2 Political power cost each update when boosting relations with nation of same ideology
	...
	VOLUNTEERS_PER_COUNTRY_ARMY = 0.02,				--WAS 0.05 Each army unit owned by the source country contributes this amount of volunteers to the limit.
	...
	MAX_OPINION_FROM_VOLUNTEERS = 100,				--WAS 30 Opinion bonus per one sent volunteer division
...
NCountry = {
	...
	BASE_COMMAND_POWER_GAIN = 0.005,				--WAS 0.006 base value for daily command power gain
...
NAI = {
	...
	DIPLOMACY_ACCEPT_VOLUNTEERS_BASE = 300,		--WAS 50 Base value of volunteer acceptance (help is welcome)
