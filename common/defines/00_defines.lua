...
NCountry = {
	EVENT_PROCESS_OFFSET = 10,						--WAS 20 Events are checked every X day per character or province (1 is ideal, but CPU heavy)
...
NProduction = {
	...
	BASE_FACTORY_EFFICIENCY_GAIN = 0.08,		--WAS 1 -- Base efficiency gain for factories per unit produced in %.
...
NMilitary = {
	...
	TRAINING_ATTRITION = 0.001,		  			   --WAS 0.06 amount of extra attrition from being in training
